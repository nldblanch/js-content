...
`});const m={type:"element",tagName:"li",properties:s,children:c};return t.patch(r,m),t.applyData(r,m)}function p2(t){let r=!1;if(t.type==="list"){r=t.spread||!1;const l=t.children;let u=-1;for(;!r&&++u<l.length;)r=jv(l[u])}return r}function jv(t){const r=t.spread;return r??t.children.length>1}function g2(t,r){const l={},u=t.all(r);let o=-1;for(typeof r.start=="number"&&r.start!==1&&(l.start=r.start);++o<u.length;){const c=u[o];if(c.type==="element"&&c.tagName==="li"&&c.properties&&Array.isArray(c.properties.className)&&c.properties.className.includes("task-list-item")){l.className=["contains-task-list"];break}}const s={type:"element",tagName:r.ordered?"ol":"ul",properties:l,children:t.wrap(u,!0)};return t.patch(r,s),t.applyData(r,s)}function y2(t,r){const l={type:"element",tagName:"p",properties:{},children:t.all(r)};return t.patch(r,l),t.applyData(r,l)}function v2(t,r){const l={type:"root",children:t.wrap(t.all(r))};return t.patch(r,l),t.applyData(r,l)}function b2(t,r){const l={type:"element",tagName:"strong",properties:{},children:t.all(r)};return t.patch(r,l),t.applyData(r,l)}function w2(t,r){const l=t.all(r),u=l.shift(),o=[];if(u){const c={type:"element",tagName:"thead",properties:{},children:t.wrap([u],!0)};t.patch(r.children[0],c),o.push(c)}if(l.length>0){const c={type:"element",tagName:"tbody",properties:{},children:t.wrap(l,!0)},d=Jf(r.children[1]),p=dv(r.children[r.children.length-1]);d&&p&&(c.position={start:d,end:p}),o.push(c)}const s={type:"element",tagName:"table",properties:{},children:t.wrap(o,!0)};return t.patch(r,s),t.applyData(r,s)}function S2(t,r,l){const u=l?l.children:void 0,s=(u?u.indexOf(r):1)===0?"th":"td",c=l&&l.type==="table"?l.align:void 0,d=c?c.length:r.children.length;let p=-1;const m=[];for(;++p<d;){const g=r.children[p],w={},b=c?c[p]:void 0;b&&(w.align=b);let E={type:"element",tagName:s,properties:w,children:[]};g&&(E.children=t.all(g),t.patch(g,E),E=t.applyData(g,E)),m.push(E)}const y={type:"element",tagName:"tr",properties:{},children:t.wrap(m,!0)};return t.patch(r,y),t.applyData(r,y)}function x2(t,r){const l={type:"element",tagName:"td",properties:{},children:t.all(r)};return t.patch(r,l),t.applyData(r,l)}const ey=9,ty=32;function E2(t){const r=String(t),l=/\r?\n|\r/g;let u=l.exec(r),o=0;const s=[];for(;u;)s.push(ny(r.slice(o,u.index),o>0,!0),u[0]),o=u.index+u[0].length,u=l.exec(r);return s.push(ny(r.slice(o),o>0,!1)),s.join("")}function ny(t,r,l){let u=0,o=t.length;if(r){let s=t.codePointAt(u);for(;s===ey||s===ty;)u++,s=t.codePointAt(u)}if(l){let s=t.codePointAt(o-1);for(;s===ey||s===ty;)o--,s=t.codePointAt(o-1)}return o>u?t.slice(u,o):""}function T2(t,r){const l={type:"text",value:E2(String(r.value))};return t.patch(r,l),t.applyData(r,l)}function C2(t,r){const l={type:"element",tagName:"hr",properties:{},children:[]};return t.patch(r,l),t.applyData(r,l)}const k2={blockquote:t2,break:n2,code:a2,delete:r2,emphasis:l2,footnoteReference:i2,heading:u2,html:o2,imageReference:s2,image:c2,inlineCode:f2,linkReference:h2,link:d2,listItem:m2,list:g2,paragraph:y2,root:v2,strong:b2,table:w2,tableCell:x2,tableRow:S2,text:T2,thematicBreak:C2,toml:oo,yaml:oo,definition:oo,footnoteDefinition:oo};function oo(){}const Nv=-1,_o=0,zi=1,wo=2,nh=3,ah=4,rh=5,lh=6,Lv=7,Uv=8,ay=typeof self=="object"?self:globalThis,R2=(t,r)=>{const l=(o,s)=>(t.set(s,o),o),u=o=>{if(t.has(o))return t.get(o);const[s,c]=r[o];switch(s){case _o:case Nv:return l(c,o);case zi:{const d=l([],o);for(const p of c)d.push(u(p));return d}case wo:{const d=l({},o);for(const[p,m]of c)d[u(p)]=u(m);return d}case nh:return l(new Date(c),o);case ah:{const{source:d,flags:p}=c;return l(new RegExp(d,p),o)}case rh:{const d=l(new Map,o);for(const[p,m]of c)d.set(u(p),u(m));return d}case lh:{const d=l(new Set,o);for(const p of c)d.add(u(p));return d}case Lv:{const{name:d,message:p}=c;return l(new ay[d](p),o)}case Uv:return l(BigInt(c),o);case"BigInt":return l(Object(BigInt(c)),o);case"ArrayBuffer":return l(new Uint8Array(c).buffer,c);case"DataView":{const{buffer:d}=new Uint8Array(c);return l(new DataView(d),c)}}return l(new ay[s](c),o)};return u},ry=t=>R2(new Map,t)(0),yl="",{toString:A2}={},{keys:D2}=Object,Ci=t=>{const r=typeof t;if(r!=="object"||!t)return[_o,r];const l=A2.call(t).slice(8,-1);switch(l){case"Array":return[zi,yl];case"Object":return[wo,yl];case"Date":return[nh,yl];case"RegExp":return[ah,yl];case"Map":return[rh,yl];case"Set":return[lh,yl];case"DataView":return[zi,l]}return l.includes("Array")?[zi,l]:l.includes("Error")?[Lv,l]:[wo,l]},so=([t,r])=>t===_o&&(r==="function"||r==="symbol"),M2=(t,r,l,u)=>{const o=(c,d)=>{const p=u.push(c)-1;return l.set(d,p),p},s=c=>{if(l.has(c))return l.get(c);let[d,p]=Ci(c);switch(d){case _o:{let y=c;switch(p){case"bigint":d=Uv,y=c.toString();break;case"function":case"symbol":if(t)throw new TypeError("unable to serialize "+p);y=null;break;case"undefined":return o([Nv],c)}return o([d,y],c)}case zi:{if(p){let w=c;return p==="DataView"?w=new Uint8Array(c.buffer):p==="ArrayBuffer"&&(w=new Uint8Array(c)),o([p,[...w]],c)}const y=[],g=o([d,y],c);for(const w of c)y.push(s(w));return g}case wo:{if(p)switch(p){case"BigInt":return o([p,c.toString()],c);case"Boolean":case"Number":case"String":return o([p,c.valueOf()],c)}if(r&&"toJSON"in c)return s(c.toJSON());const y=[],g=o([d,y],c);for(const w of D2(c))(t||!so(Ci(c[w])))&&y.push([s(w),s(c[w])]);return g}case nh:return o([d,c.toISOString()],c);case ah:{const{source:y,flags:g}=c;return o([d,{source:y,flags:g}],c)}case rh:{const y=[],g=o([d,y],c);for(const[w,b]of c)(t||!(so(Ci(w))||so(Ci(b))))&&y.push([s(w),s(b)]);return g}case lh:{const y=[],g=o([d,y],c);for(const w of c)(t||!so(Ci(w)))&&y.push(s(w));return g}}const{message:m}=c;return o([d,{name:p,message:m}],c)};return s},ly=(t,{json:r,lossy:l}={})=>{const u=[];return M2(!(r||l),!!r,new Map,u)(t),u},So=typeof structuredClone=="function"?(t,r)=>r&&("json"in r||"lossy"in r)?ry(ly(t,r)):structuredClone(t):(t,r)=>ry(ly(t,r));function z2(t,r){const l=[{type:"text",value:"↩"}];return r>1&&l.push({type:"element",tagName:"sup",properties:{},children:[{type:"text",value:String(r)}]}),l}function _2(t,r){return"Back to reference "+(t+1)+(r>1?"-"+r:"")}function O2(t){const r=typeof t.options.clobberPrefix=="string"?t.options.clobberPrefix:"user-content-",l=t.options.footnoteBackContent||z2,u=t.options.footnoteBackLabel||_2,o=t.options.footnoteLabel||"Footnotes",s=t.options.footnoteLabelTagName||"h2",c=t.options.footnoteLabelProperties||{className:["sr-only"]},d=[];let p=-1;for(;++p<t.footnoteOrder.length;){const m=t.footnoteById.get(t.footnoteOrder[p]);if(!m)continue;const y=t.all(m),g=String(m.identifier).toUpperCase(),w=kl(g.toLowerCase());let b=0;const E=[],z=t.footnoteCounts.get(g);for(;z!==void 0&&++b<=z;){E.length>0&&E.push({type:"text",value:" "});let L=typeof l=="string"?l:l(p,b);typeof L=="string"&&(L={type:"text",value:L}),E.push({type:"element",tagName:"a",properties:{href:"#"+r+"fnref-"+w+(b>1?"-"+b:""),dataFootnoteBackref:"",ariaLabel:typeof u=="string"?u:u(p,b),className:["data-footnote-backref"]},children:Array.isArray(L)?L:[L]})}const j=y[y.length-1];if(j&&j.type==="element"&&j.tagName==="p"){const L=j.children[j.children.length-1];L&&L.type==="text"?L.value+=" ":j.children.push({type:"text",value:" "}),j.children.push(...E)}else y.push(...E);const A={type:"element",tagName:"li",properties:{id:r+"fn-"+w},children:t.wrap(y,!0)};t.patch(m,A),d.push(A)}if(d.length!==0)return{type:"element",tagName:"section",properties:{dataFootnotes:!0,className:["footnotes"]},children:[{type:"element",tagName:s,properties:{...So(c),id:"footnote-label"},children:[{type:"text",value:o}]},{type:"text",value:`
`},{type:"element",tagName:"ol",properties:{},children:t.wrap(d,!0)},{type:"text",value:`
`}]}}const Oo=(function(t){if(t==null)return U2;if(typeof t=="function")return jo(t);if(typeof t=="object")return Array.isArray(t)?j2(t):N2(t);if(typeof t=="string")return L2(t);throw new Error("Expected function, string, or object as test")});function j2(t){const r=[];let l=-1;for(;++l<t.length;)r[l]=Oo(t[l]);return jo(u);function u(...o){let s=-1;for(;++s<r.length;)if(r[s].apply(this,o))return!0;return!1}}function N2(t){const r=t;return jo(l);function l(u){const o=u;let s;for(s in t)if(o[s]!==r[s])return!1;return!0}}function L2(t){return jo(r);function r(l){return l&&l.type===t}}function jo(t){return r;function r(l,u,o){return!!(H2(l)&&t.call(this,l,typeof u=="number"?u:void 0,o||void 0))}}function U2(){return!0}function H2(t){return t!==null&&typeof t=="object"&&"type"in t}const Hv=[],B2=!0,Af=!1,Y2="skip";function Bv(t,r,l,u){let o;typeof r=="function"&&typeof l!="function"?(u=l,l=r):o=r;const s=Oo(o),c=u?-1:1;d(t,void 0,[])();function d(p,m,y){const g=p&&typeof p=="object"?p:{};if(typeof g.type=="string"){const b=typeof g.tagName=="string"?g.tagName:typeof g.name=="string"?g.name:void 0;Object.defineProperty(w,"name",{value:"node ("+(p.type+(b?"<"+b+">":""))+")"})}return w;function w(){let b=Hv,E,z,j;if((!r||s(p,m,y[y.length-1]||void 0))&&(b=q2(l(p,y)),b[0]===Af))return b;if("children"in p&&p.children){const A=p;if(A.children&&b[0]!==Y2)for(z=(u?A.children.length:-1)+c,j=y.concat(A);z>-1&&z<A.children.length;){const L=A.children[z];if(E=d(L,z,j)(),E[0]===Af)return E;z=typeof E[1]=="number"?E[1]:z+c}}return b}}}function q2(t){return Array.isArray(t)?t:typeof t=="number"?[B2,t]:t==null?Hv:[t]}function ih(t,r,l,u){let o,s,c;typeof r=="function"&&typeof l!="function"?(s=void 0,c=r,o=l):(s=r,c=l,o=u),Bv(t,s,d,o);function d(p,m){const y=m[m.length-1],g=y?y.children.indexOf(p):void 0;return c(p,g,y)}}const Df={}.hasOwnProperty,I2={};function F2(t,r){const l=r||I2,u=new Map,o=new Map,s=new Map,c={...k2,...l.handlers},d={all:m,applyData:V2,definitionById:u,footnoteById:o,footnoteCounts:s,footnoteOrder:[],handlers:c,one:p,options:l,patch:G2,wrap:Q2};return ih(t,function(y){if(y.type==="definition"||y.type==="footnoteDefinition"){const g=y.type==="definition"?u:o,w=String(y.identifier).toUpperCase();g.has(w)||g.set(w,y)}}),d;function p(y,g){const w=y.type,b=d.handlers[w];if(Df.call(d.handlers,w)&&b)return b(d,y,g);if(d.options.passThrough&&d.options.passThrough.includes(w)){if("children"in y){const{children:z,...j}=y,A=So(j);return A.children=d.all(y),A}return So(y)}return(d.options.unknownHandler||X2)(d,y,g)}function m(y){const g=[];if("children"in y){const w=y.children;let b=-1;for(;++b<w.length;){const E=d.one(w[b],y);if(E){if(b&&w[b-1].type==="break"&&(!Array.isArray(E)&&E.type==="text"&&(E.value=iy(E.value)),!Array.isArray(E)&&E.type==="element")){const z=E.children[0];z&&z.type==="text"&&(z.value=iy(z.value))}Array.isArray(E)?g.push(...E):g.push(E)}}}return g}}function G2(t,r){t.position&&(r.position=_x(t))}function V2(t,r){let l=r;if(t&&t.data){const u=t.data.hName,o=t.data.hChildren,s=t.data.hProperties;if(typeof u=="string")if(l.type==="element")l.tagName=u;else{const c="children"in l?l.children:[l];l={type:"element",tagName:u,properties:{},children:c}}l.type==="element"&&s&&Object.assign(l.properties,So(s)),"children"in l&&l.children&&o!==null&&o!==void 0&&(l.children=o)}return l}function X2(t,r){const l=r.data||{},u="value"in r&&!(Df.call(l,"hProperties")||Df.call(l,"hChildren"))?{type:"text",value:r.value}:{type:"element",tagName:"div",properties:{},children:t.all(r)};return t.patch(r,u),t.applyData(r,u)}function Q2(t,r){const l=[];let u=-1;for(r&&l.push({type:"text",value:`
`});++u<t.length;)u&&l.push({type:"text",value:`
`}),l.push(t[u]);return r&&t.length>0&&l.push({type:"text",value:`
`}),l}function iy(t){let r=0,l=t.charCodeAt(r);for(;l===9||l===32;)r++,l=t.charCodeAt(r);return t.slice(r)}function uy(t,r){const l=F2(t,r),u=l.one(t,void 0),o=O2(l),s=Array.isArray(u)?{type:"root",children:u}:u||{type:"root",children:[]};return o&&s.children.push({type:"text",value:`
`},o),s}function Z2(t,r){return t&&"run"in t?async function(l,u){const o=uy(l,{file:u,...r});await t.run(o,u)}:function(l,u){return uy(l,{file:u,...t||r})}}function oy(t){if(t)throw t}var lf,sy;function J2(){if(sy)return lf;sy=1;var t=Object.prototype.hasOwnProperty,r=Object.prototype.toString,l=Object.defineProperty,u=Object.getOwnPropertyDescriptor,o=function(m){return typeof Array.isArray=="function"?Array.isArray(m):r.call(m)==="[object Array]"},s=function(m){if(!m||r.call(m)!=="[object Object]")return!1;var y=t.call(m,"constructor"),g=m.constructor&&m.constructor.prototype&&t.call(m.constructor.prototype,"isPrototypeOf");if(m.constructor&&!y&&!g)return!1;var w;for(w in m);return typeof w>"u"||t.call(m,w)},c=function(m,y){l&&y.name==="__proto__"?l(m,y.name,{enumerable:!0,configurable:!0,value:y.newValue,writable:!0}):m[y.name]=y.newValue},d=function(m,y){if(y==="__proto__")if(t.call(m,y)){if(u)return u(m,y).value}else return;return m[y]};return lf=function p(){var m,y,g,w,b,E,z=arguments[0],j=1,A=arguments.length,L=!1;for(typeof z=="boolean"&&(L=z,z=arguments[1]||{},j=2),(z==null||typeof z!="object"&&typeof z!="function")&&(z={});j<A;++j)if(m=arguments[j],m!=null)for(y in m)g=d(z,y),w=d(m,y),z!==w&&(L&&w&&(s(w)||(b=o(w)))?(b?(b=!1,E=g&&o(g)?g:[]):E=g&&s(g)?g:{},c(z,{name:y,newValue:p(L,E,w)})):typeof w<"u"&&c(z,{name:y,newValue:w}));return z},lf}var P2=J2();const uf=jf(P2);function Mf(t){if(typeof t!="object"||t===null)return!1;const r=Object.getPrototypeOf(t);return(r===null||r===Object.prototype||Object.getPrototypeOf(r)===null)&&!(Symbol.toStringTag in t)&&!(Symbol.iterator in t)}function K2(){const t=[],r={run:l,use:u};return r;function l(...o){let s=-1;const c=o.pop();if(typeof c!="function")throw new TypeError("Expected function as last argument, not "+c);d(null,...o);function d(p,...m){const y=t[++s];let g=-1;if(p){c(p);return}for(;++g<o.length;)(m[g]===null||m[g]===void 0)&&(m[g]=o[g]);o=m,y?W2(y,d)(...m):c(null,...m)}}function u(o){if(typeof o!="function")throw new TypeError("Expected `middelware` to be a function, not "+o);return t.push(o),r}}function W2(t,r){let l;return u;function u(...c){const d=t.length>c.length;let p;d&&c.push(o);try{p=t.apply(this,c)}catch(m){const y=m;if(d&&l)throw y;return o(y)}d||(p&&p.then&&typeof p.then=="function"?p.then(s,o):p instanceof Error?o(p):s(p))}function o(c,...d){l||(l=!0,r(c,...d))}function s(c){o(null,c)}}const Jn={basename:$2,dirname:eC,extname:tC,join:nC,sep:"/"};function $2(t,r){if(r!==void 0&&typeof r!="string")throw new TypeError('"ext" argument must be a string');Gi(t);let l=0,u=-1,o=t.length,s;if(r===void 0||r.length===0||r.length>t.length){for(;o--;)if(t.codePointAt(o)===47){if(s){l=o+1;break}}else u<0&&(s=!0,u=o+1);return u<0?"":t.slice(l,u)}if(r===t)return"";let c=-1,d=r.length-1;for(;o--;)if(t.codePointAt(o)===47){if(s){l=o+1;break}}else c<0&&(s=!0,c=o+1),d>-1&&(t.codePointAt(o)===r.codePointAt(d--)?d<0&&(u=o):(d=-1,u=c));return l===u?u=c:u<0&&(u=t.length),t.slice(l,u)}function eC(t){if(Gi(t),t.length===0)return".";let r=-1,l=t.length,u;for(;--l;)if(t.codePointAt(l)===47){if(u){r=l;break}}else u||(u=!0);return r<0?t.codePointAt(0)===47?"/":".":r===1&&t.codePointAt(0)===47?"//":t.slice(0,r)}function tC(t){Gi(t);let r=t.length,l=-1,u=0,o=-1,s=0,c;for(;r--;){const d=t.codePointAt(r);if(d===47){if(c){u=r+1;break}continue}l<0&&(c=!0,l=r+1),d===46?o<0?o=r:s!==1&&(s=1):o>-1&&(s=-1)}return o<0||l<0||s===0||s===1&&o===l-1&&o===u+1?"":t.slice(o,l)}function nC(...t){let r=-1,l;for(;++r<t.length;)Gi(t[r]),t[r]&&(l=l===void 0?t[r]:l+"/"+t[r]);return l===void 0?".":aC(l)}function aC(t){Gi(t);const r=t.codePointAt(0)===47;let l=rC(t,!r);return l.length===0&&!r&&(l="."),l.length>0&&t.codePointAt(t.length-1)===47&&(l+="/"),r?"/"+l:l}function rC(t,r){let l="",u=0,o=-1,s=0,c=-1,d,p;for(;++c<=t.length;){if(c<t.length)d=t.codePointAt(c);else{if(d===47)break;d=47}if(d===47){if(!(o===c-1||s===1))if(o!==c-1&&s===2){if(l.length<2||u!==2||l.codePointAt(l.length-1)!==46||l.codePointAt(l.length-2)!==46){if(l.length>2){if(p=l.lastIndexOf("/"),p!==l.length-1){p<0?(l="",u=0):(l=l.slice(0,p),u=l.length-1-l.lastIndexOf("/")),o=c,s=0;continue}}else if(l.length>0){l="",u=0,o=c,s=0;continue}}r&&(l=l.length>0?l+"/..":"..",u=2)}else l.length>0?l+="/"+t.slice(o+1,c):l=t.slice(o+1,c),u=c-o-1;o=c,s=0}else d===46&&s>-1?s++:s=-1}return l}function Gi(t){if(typeof t!="string")throw new TypeError("Path must be a string. Received "+JSON.stringify(t))}const lC={cwd:iC};function iC(){return"/"}function zf(t){return!!(t!==null&&typeof t=="object"&&"href"in t&&t.href&&"protocol"in t&&t.protocol&&t.auth===void 0)}function uC(t){if(typeof t=="string")t=new URL(t);else if(!zf(t)){const r=new TypeError('The "path" argument must be of type string or an instance of URL. Received `'+t+"`");throw r.code="ERR_INVALID_ARG_TYPE",r}if(t.protocol!=="file:"){const r=new TypeError("The URL must be of scheme file");throw r.code="ERR_INVALID_URL_SCHEME",r}return oC(t)}function oC(t){if(t.hostname!==""){const u=new TypeError('File URL host must be "localhost" or empty on darwin');throw u.code="ERR_INVALID_FILE_URL_HOST",u}const r=t.pathname;let l=-1;for(;++l<r.length;)if(r.codePointAt(l)===37&&r.codePointAt(l+1)===50){const u=r.codePointAt(l+2);if(u===70||u===102){const o=new TypeError("File URL path must not include encoded / characters");throw o.code="ERR_INVALID_FILE_URL_PATH",o}}return decodeURIComponent(r)}const of=["history","path","basename","stem","extname","dirname"];class Yv{constructor(r){let l;r?zf(r)?l={path:r}:typeof r=="string"||sC(r)?l={value:r}:l=r:l={},this.cwd="cwd"in l?"":lC.cwd(),this.data={},this.history=[],this.messages=[],this.value,this.map,this.result,this.stored;let u=-1;for(;++u<of.length;){const s=of[u];s in l&&l[s]!==void 0&&l[s]!==null&&(this[s]=s==="history"?[...l[s]]:l[s])}let o;for(o in l)of.includes(o)||(this[o]=l[o])}get basename(){return typeof this.path=="string"?Jn.basename(this.path):void 0}set basename(r){cf(r,"basename"),sf(r,"basename"),this.path=Jn.join(this.dirname||"",r)}get dirname(){return typeof this.path=="string"?Jn.dirname(this.path):void 0}set dirname(r){cy(this.basename,"dirname"),this.path=Jn.join(r||"",this.basename)}get extname(){return typeof this.path=="string"?Jn.extname(this.path):void 0}set extname(r){if(sf(r,"extname"),cy(this.dirname,"extname"),r){if(r.codePointAt(0)!==46)throw new Error("`extname` must start with `.`");if(r.includes(".",1))throw new Error("`extname` cannot contain multiple dots")}this.path=Jn.join(this.dirname,this.stem+(r||""))}get path(){return this.history[this.history.length-1]}set path(r){zf(r)&&(r=uC(r)),cf(r,"path"),this.path!==r&&this.history.push(r)}get stem(){return typeof this.path=="string"?Jn.basename(this.path,this.extname):void 0}set stem(r){cf(r,"stem"),sf(r,"stem"),this.path=Jn.join(this.dirname||"",r+(this.extname||""))}fail(r,l,u){const o=this.message(r,l,u);throw o.fatal=!0,o}info(r,l,u){const o=this.message(r,l,u);return o.fatal=void 0,o}message(r,l,u){const o=new Gt(r,l,u);return this.path&&(o.name=this.path+":"+o.name,o.file=this.path),o.fatal=!1,this.messages.push(o),o}toString(r){return this.value===void 0?"":typeof this.value=="string"?this.value:new TextDecoder(r||void 0).decode(this.value)}}function sf(t,r){if(t&&t.includes(Jn.sep))throw new Error("`"+r+"` cannot be a path: did not expect `"+Jn.sep+"`")}function cf(t,r){if(!t)throw new Error("`"+r+"` cannot be empty")}function cy(t,r){if(!t)throw new Error("Setting `"+r+"` requires `path` to be set too")}function sC(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const cC=(function(t){const u=this.constructor.prototype,o=u[t],s=function(){return o.apply(s,arguments)};return Object.setPrototypeOf(s,u),s}),fC={}.hasOwnProperty;class uh extends cC{constructor(){super("copy"),this.Compiler=void 0,this.Parser=void 0,this.attachers=[],this.compiler=void 0,this.freezeIndex=-1,this.frozen=void 0,this.namespace={},this.parser=void 0,this.transformers=K2()}copy(){const r=new uh;let l=-1;for(;++l<this.attachers.length;){const u=this.attachers[l];r.use(...u)}return r.data(uf(!0,{},this.namespace)),r}data(r,l){return typeof r=="string"?arguments.length===2?(df("data",this.frozen),this.namespace[r]=l,this):fC.call(this.namespace,r)&&this.namespace[r]||void 0:r?(df("data",this.frozen),this.namespace=r,this):this.namespace}freeze(){if(this.frozen)return this;const r=this;for(;++this.freezeIndex<this.attachers.length;){const[l,...u]=this.attachers[this.freezeIndex];if(u[0]===!1)continue;u[0]===!0&&(u[0]=void 0);const o=l.call(r,...u);typeof o=="function"&&this.transformers.use(o)}return this.frozen=!0,this.freezeIndex=Number.POSITIVE_INFINITY,this}parse(r){this.freeze();const l=co(r),u=this.parser||this.Parser;return ff("parse",u),u(String(l),l)}process(r,l){const u=this;return this.freeze(),ff("process",this.parser||this.Parser),hf("process",this.compiler||this.Compiler),l?o(void 0,l):new Promise(o);function o(s,c){const d=co(r),p=u.parse(d);u.run(p,d,function(y,g,w){if(y||!g||!w)return m(y);const b=g,E=u.stringify(b,w);mC(E)?w.value=E:w.result=E,m(y,w)});function m(y,g){y||!g?c(y):s?s(g):l(void 0,g)}}}processSync(r){let l=!1,u;return this.freeze(),ff("processSync",this.parser||this.Parser),hf("processSync",this.compiler||this.Compiler),this.process(r,o),hy("processSync","process",l),u;function o(s,c){l=!0,oy(s),u=c}}run(r,l,u){fy(r),this.freeze();const o=this.transformers;return!u&&typeof l=="function"&&(u=l,l=void 0),u?s(void 0,u):new Promise(s);function s(c,d){const p=co(l);o.run(r,p,m);function m(y,g,w){const b=g||r;y?d(y):c?c(b):u(void 0,b,w)}}}runSync(r,l){let u=!1,o;return this.run(r,l,s),hy("runSync","run",u),o;function s(c,d){oy(c),o=d,u=!0}}stringify(r,l){this.freeze();const u=co(l),o=this.compiler||this.Compiler;return hf("stringify",o),fy(r),o(r,u)}use(r,...l){const u=this.attachers,o=this.namespace;if(df("use",this.frozen),r!=null)if(typeof r=="function")p(r,l);else if(typeof r=="object")Array.isArray(r)?d(r):c(r);else throw new TypeError("Expected usable value, not `"+r+"`");return this;function s(m){if(typeof m=="function")p(m,[]);else if(typeof m=="object")if(Array.isArray(m)){const[y,...g]=m;p(y,g)}else c(m);else throw new TypeError("Expected usable value, not `"+m+"`")}function c(m){if(!("plugins"in m)&&!("settings"in m))throw new Error("Expected usable value but received an empty preset, which is probably a mistake: presets typically come with `plugins` and sometimes with `settings`, but this has neither");d(m.plugins),m.settings&&(o.settings=uf(!0,o.settings,m.settings))}function d(m){let y=-1;if(m!=null)if(Array.isArray(m))for(;++y<m.length;){const g=m[y];s(g)}else throw new TypeError("Expected a list of plugins, not `"+m+"`")}function p(m,y){let g=-1,w=-1;for(;++g<u.length;)if(u[g][0]===m){w=g;break}if(w===-1)u.push([m,...y]);else if(y.length>0){let[b,...E]=y;const z=u[w][1];Mf(z)&&Mf(b)&&(b=uf(!0,z,b)),u[w]=[m,b,...E]}}}}const hC=new uh().freeze();function ff(t,r){if(typeof r!="function")throw new TypeError("Cannot `"+t+"` without `parser`")}function hf(t,r){if(typeof r!="function")throw new TypeError("Cannot `"+t+"` without `compiler`")}function df(t,r){if(r)throw new Error("Cannot call `"+t+"` on a frozen processor.\nCreate a new processor first, by calling it: use `processor()` instead of `processor`.")}function fy(t){if(!Mf(t)||typeof t.type!="string")throw new TypeError("Expected node, got `"+t+"`")}function hy(t,r,l){if(!l)throw new Error("`"+t+"` finished async. Use `"+r+"` instead")}function co(t){return dC(t)?t:new Yv(t)}function dC(t){return!!(t&&typeof t=="object"&&"message"in t&&"messages"in t)}function mC(t){return typeof t=="string"||pC(t)}function pC(t){return!!(t&&typeof t=="object"&&"byteLength"in t&&"byteOffset"in t)}const gC="https://github.com/remarkjs/react-markdown/blob/main/changelog.md",dy=[],my={allowDangerousHtml:!0},yC=/^(https?|ircs?|mailto|xmpp)$/i,vC=[{from:"astPlugins",id:"remove-buggy-html-in-markdown-parser"},{from:"allowDangerousHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"allowNode",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowElement"},{from:"allowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"allowedElements"},{from:"className",id:"remove-classname"},{from:"disallowedTypes",id:"replace-allownode-allowedtypes-and-disallowedtypes",to:"disallowedElements"},{from:"escapeHtml",id:"remove-buggy-html-in-markdown-parser"},{from:"includeElementIndex",id:"#remove-includeelementindex"},{from:"includeNodeIndex",id:"change-includenodeindex-to-includeelementindex"},{from:"linkTarget",id:"remove-linktarget"},{from:"plugins",id:"change-plugins-to-remarkplugins",to:"remarkPlugins"},{from:"rawSourcePos",id:"#remove-rawsourcepos"},{from:"renderers",id:"change-renderers-to-components",to:"components"},{from:"source",id:"change-source-to-children",to:"children"},{from:"sourcePos",id:"#remove-sourcepos"},{from:"transformImageUri",id:"#add-urltransform",to:"urlTransform"},{from:"transformLinkUri",id:"#add-urltransform",to:"urlTransform"}];function bC(t){const r=wC(t),l=SC(t);return xC(r.runSync(r.parse(l),l),t)}function wC(t){const r=t.rehypePlugins||dy,l=t.remarkPlugins||dy,u=t.remarkRehypeOptions?{...t.remarkRehypeOptions,...my}:my;return hC().use(e2).use(l).use(Z2,u).use(r)}function SC(t){const r=t.children||"",l=new Yv;return typeof r=="string"&&(l.value=r),l}function xC(t,r){const l=r.allowedElements,u=r.allowElement,o=r.components,s=r.disallowedElements,c=r.skipHtml,d=r.unwrapDisallowed,p=r.urlTransform||EC;for(const y of vC)Object.hasOwn(r,y.from)&&(""+y.from+(y.to?"use `"+y.to+"` instead":"remove it")+gC+y.id,void 0);return ih(t,m),Ux(t,{Fragment:se.Fragment,components:o,ignoreInvalidStyle:!0,jsx:se.jsx,jsxs:se.jsxs,passKeys:!0,passNode:!0});function m(y,g,w){if(y.type==="raw"&&w&&typeof g=="number")return c?w.children.splice(g,1):w.children[g]={type:"text",value:y.value},g;if(y.type==="element"){let b;for(b in nf)if(Object.hasOwn(nf,b)&&Object.hasOwn(y.properties,b)){const E=y.properties[b],z=nf[b];(z===null||z.includes(y.tagName))&&(y.properties[b]=p(String(E||""),b,y))}}if(y.type==="element"){let b=l?!l.includes(y.tagName):s?s.includes(y.tagName):!1;if(!b&&u&&typeof g=="number"&&(b=!u(y,g,w)),b&&w&&typeof g=="number")return d&&y.children?w.children.splice(g,1,...y.children):w.children.splice(g,1),g}}}function EC(t){const r=t.indexOf(":"),l=t.indexOf("?"),u=t.indexOf("#"),o=t.indexOf("/");return r===-1||o!==-1&&r>o||l!==-1&&r>l||u!==-1&&r>u||yC.test(t.slice(0,r))?t:""}function py(t,r){const l=String(t);if(typeof r!="string")throw new TypeError("Expected character");let u=0,o=l.indexOf(r);for(;o!==-1;)u++,o=l.indexOf(r,o+r.length);return u}function TC(t){if(typeof t!="string")throw new TypeError("Expected a string");return t.replace(/[|\\{}()[\]^$+*?.]/g,"\\$&").replace(/-/g,"\\x2d")}function CC(t,r,l){const o=Oo((l||{}).ignore||[]),s=kC(r);let c=-1;for(;++c<s.length;)Bv(t,"text",d);function d(m,y){let g=-1,w;for(;++g<y.length;){const b=y[g],E=w?w.children:void 0;if(o(b,E?E.indexOf(b):void 0,w))return;w=b}if(w)return p(m,y)}function p(m,y){const g=y[y.length-1],w=s[c][0],b=s[c][1];let E=0;const j=g.children.indexOf(m);let A=!1,L=[];w.lastIndex=0;let H=w.exec(m.value);for(;H;){const fe=H.index,oe={index:H.index,input:H.input,stack:[...y,m]};let q=b(...H,oe);if(typeof q=="string"&&(q=q.length>0?{type:"text",value:q}:void 0),q===!1?w.lastIndex=fe+1:(E!==fe&&L.push({type:"text",value:m.value.slice(E,fe)}),Array.isArray(q)?L.push(...q):q&&L.push(q),E=fe+H[0].length,A=!0),!w.global)break;H=w.exec(m.value)}return A?(E<m.value.length&&L.push({type:"text",value:m.value.slice(E)}),g.children.splice(j,1,...L)):L=[m],j+L.length}}function kC(t){const r=[];if(!Array.isArray(t))throw new TypeError("Expected find and replace tuple or list of tuples");const l=!t[0]||Array.isArray(t[0])?t:[t];let u=-1;for(;++u<l.length;){const o=l[u];r.push([RC(o[0]),AC(o[1])])}return r}function RC(t){return typeof t=="string"?new RegExp(TC(t),"g"):t}function AC(t){return typeof t=="function"?t:function(){return t}}const mf="phrasing",pf=["autolink","link","image","label"];function DC(){return{transforms:[LC],enter:{literalAutolink:zC,literalAutolinkEmail:gf,literalAutolinkHttp:gf,literalAutolinkWww:gf},exit:{literalAutolink:NC,literalAutolinkEmail:jC,literalAutolinkHttp:_C,literalAutolinkWww:OC}}}function MC(){return{unsafe:[{character:"@",before:"[+\\-.\\w]",after:"[\\-.\\w]",inConstruct:mf,notInConstruct:pf},{character:".",before:"[Ww]",after:"[\\-.\\w]",inConstruct:mf,notInConstruct:pf},{character:":",before:"[ps]",after:"\\/",inConstruct:mf,notInConstruct:pf}]}}function zC(t){this.enter({type:"link",title:null,url:"",children:[]},t)}function gf(t){this.config.enter.autolinkProtocol.call(this,t)}function _C(t){this.config.exit.autolinkProtocol.call(this,t)}function OC(t){this.config.exit.data.call(this,t);const r=this.stack[this.stack.length-1];r.type,r.url="http://"+this.sliceSerialize(t)}function jC(t){this.config.exit.autolinkEmail.call(this,t)}function NC(t){this.exit(t)}function LC(t){CC(t,[[/(https?:\/\/|www(?=\.))([-.\w]+)([^ \t\r\n]*)/gi,UC],[new RegExp("(?<=^|\\s|\\p{P}|\\p{S})([-.\\w+]+)@([-\\w]+(?:\\.[-\\w]+)+)","gu"),HC]],{ignore:["link","linkReference"]})}function UC(t,r,l,u,o){let s="";if(!qv(o)||(/^w/i.test(r)&&(l=r+l,r="",s="http://"),!BC(l)))return!1;const c=YC(l+u);if(!c[0])return!1;const d={type:"link",title:null,url:s+r+c[0],children:[{type:"text",value:r+c[0]}]};return c[1]?[d,{type:"text",value:c[1]}]:d}function HC(t,r,l,u){return!qv(u,!0)||/[-\d_]$/.test(l)?!1:{type:"link",title:null,url:"mailto:"+r+"@"+l,children:[{type:"text",value:r+"@"+l}]}}function BC(t){const r=t.split(".");return!(r.length<2||r[r.length-1]&&(/_/.test(r[r.length-1])||!/[a-zA-Z\d]/.test(r[r.length-1]))||r[r.length-2]&&(/_/.test(r[r.length-2])||!/[a-zA-Z\d]/.test(r[r.length-2])))}function YC(t){const r=/[!"&'),.:;<>?\]}]+$/.exec(t);if(!r)return[t,void 0];t=t.slice(0,r.index);let l=r[0],u=l.indexOf(")");const o=py(t,"(");let s=py(t,")");for(;u!==-1&&o>s;)t+=l.slice(0,u+1),l=l.slice(u+1),u=l.indexOf(")"),s++;return[t,l]}function qv(t,r){const l=t.input.charCodeAt(t.index-1);return(t.index===0||_r(l)||Mo(l))&&(!r||l!==47)}Iv.peek=JC;function qC(){this.buffer()}function IC(t){this.enter({type:"footnoteReference",identifier:"",label:""},t)}function FC(){this.buffer()}function GC(t){this.enter({type:"footnoteDefinition",identifier:"",label:"",children:[]},t)}function VC(t){const r=this.resume(),l=this.stack[this.stack.length-1];l.type,l.identifier=Fn(this.sliceSerialize(t)).toLowerCase(),l.label=r}function XC(t){this.exit(t)}function QC(t){const r=this.resume(),l=this.stack[this.stack.length-1];l.type,l.identifier=Fn(this.sliceSerialize(t)).toLowerCase(),l.label=r}function ZC(t){this.exit(t)}function JC(){return"["}function Iv(t,r,l,u){const o=l.createTracker(u);let s=o.move("[^");const c=l.enter("footnoteReference"),d=l.enter("reference");return s+=o.move(l.safe(l.associationId(t),{after:"]",before:s})),d(),c(),s+=o.move("]"),s}function PC(){return{enter:{gfmFootnoteCallString:qC,gfmFootnoteCall:IC,gfmFootnoteDefinitionLabelString:FC,gfmFootnoteDefinition:GC},exit:{gfmFootnoteCallString:VC,gfmFootnoteCall:XC,gfmFootnoteDefinitionLabelString:QC,gfmFootnoteDefinition:ZC}}}function KC(t){let r=!1;return t&&t.firstLineBlank&&(r=!0),{handlers:{footnoteDefinition:l,footnoteReference:Iv},unsafe:[{character:"[",inConstruct:["label","phrasing","reference"]}]};function l(u,o,s,c){const d=s.createTracker(c);let p=d.move("[^");const m=s.enter("footnoteDefinition"),y=s.enter("label");return p+=d.move(s.safe(s.associationId(u),{before:p,after:"]"})),y(),p+=d.move("]:"),u.children&&u.children.length>0&&(d.shift(4),p+=d.move((r?`
`:" ")+s.indentLines(s.containerFlow(u,d.current()),r?Fv:WC))),m(),p}}function WC(t,r,l){return r===0?t:Fv(t,r,l)}function Fv(t,r,l){return(l?"":"    ")+t}const $C=["autolink","destinationLiteral","destinationRaw","reference","titleQuote","titleApostrophe"];Gv.peek=rk;function ek(){return{canContainEols:["delete"],enter:{strikethrough:nk},exit:{strikethrough:ak}}}function tk(){return{unsafe:[{character:"~",inConstruct:"phrasing",notInConstruct:$C}],handlers:{delete:Gv}}}function nk(t){this.enter({type:"delete",children:[]},t)}function ak(t){this.exit(t)}function Gv(t,r,l,u){const o=l.createTracker(u),s=l.enter("strikethrough");let c=o.move("~~");return c+=l.containerPhrasing(t,{...o.current(),before:c,after:"~"}),c+=o.move("~~"),s(),c}function rk(){return"~"}function lk(t){return t.length}function ik(t,r){const l=r||{},u=(l.align||[]).concat(),o=l.stringLength||lk,s=[],c=[],d=[],p=[];let m=0,y=-1;for(;++y<t.length;){const z=[],j=[];let A=-1;for(t[y].length>m&&(m=t[y].length);++A<t[y].length;){const L=uk(t[y][A]);if(l.alignDelimiters!==!1){const H=o(L);j[A]=H,(p[A]===void 0||H>p[A])&&(p[A]=H)}z.push(L)}c[y]=z,d[y]=j}let g=-1;if(typeof u=="object"&&"length"in u)for(;++g<m;)s[g]=gy(u[g]);else{const z=gy(u);for(;++g<m;)s[g]=z}g=-1;const w=[],b=[];for(;++g<m;){const z=s[g];let j="",A="";z===99?(j=":",A=":"):z===108?j=":":z===114&&(A=":");let L=l.alignDelimiters===!1?1:Math.max(1,p[g]-j.length-A.length);const H=j+"-".repeat(L)+A;l.alignDelimiters!==!1&&(L=j.length+L+A.length,L>p[g]&&(p[g]=L),b[g]=L),w[g]=H}c.splice(1,0,w),d.splice(1,0,b),y=-1;const E=[];for(;++y<c.length;){const z=c[y],j=d[y];g=-1;const A=[];for(;++g<m;){const L=z[g]||"";let H="",fe="";if(l.alignDelimiters!==!1){const oe=p[g]-(j[g]||0),q=s[g];q===114?H=" ".repeat(oe):q===99?oe%2?(H=" ".repeat(oe/2+.5),fe=" ".repeat(oe/2-.5)):(H=" ".repeat(oe/2),fe=H):fe=" ".repeat(oe)}l.delimiterStart!==!1&&!g&&A.push("|"),l.padding!==!1&&!(l.alignDelimiters===!1&&L==="")&&(l.delimiterStart!==!1||g)&&A.push(" "),l.alignDelimiters!==!1&&A.push(H),A.push(L),l.alignDelimiters!==!1&&A.push(fe),l.padding!==!1&&A.push(" "),(l.delimiterEnd!==!1||g!==m-1)&&A.push("|")}E.push(l.delimiterEnd===!1?A.join("").replace(/ +$/,""):A.join(""))}return E.join(`
`)}function uk(t){return t==null?"":String(t)}function gy(t){const r=typeof t=="string"?t.codePointAt(0):0;return r===67||r===99?99:r===76||r===108?108:r===82||r===114?114:0}function ok(t,r,l,u){const o=l.enter("blockquote"),s=l.createTracker(u);s.move("> "),s.shift(2);const c=l.indentLines(l.containerFlow(t,s.current()),sk);return o(),c}function sk(t,r,l){return">"+(l?"":" ")+t}function ck(t,r){return yy(t,r.inConstruct,!0)&&!yy(t,r.notInConstruct,!1)}function yy(t,r,l){if(typeof r=="string"&&(r=[r]),!r||r.length===0)return l;let u=-1;for(;++u<r.length;)if(t.includes(r[u]))return!0;return!1}function vy(t,r,l,u){let o=-1;for(;++o<l.unsafe.length;)if(l.unsafe[o].character===`
`&&ck(l.stack,l.unsafe[o]))return/[ \t]/.test(u.before)?"":" ";return`\\
`}function fk(t,r){const l=String(t);let u=l.indexOf(r),o=u,s=0,c=0;if(typeof r!="string")throw new TypeError("Expected substring");for(;u!==-1;)u===o?++s>c&&(c=s):s=1,o=u+r.length,u=l.indexOf(r,o);return c}function hk(t,r){return!!(r.options.fences===!1&&t.value&&!t.lang&&/[^ \r\n]/.test(t.value)&&!/^[\t ]*(?:[\r\n]|$)|(?:^|[\r\n])[\t ]*$/.test(t.value))}function dk(t){const r=t.options.fence||"`";if(r!=="`"&&r!=="~")throw new Error("Cannot serialize code with `"+r+"` for `options.fence`, expected `` ` `` or `~`");return r}function mk(t,r,l,u){const o=dk(l),s=t.value||"",c=o==="`"?"GraveAccent":"Tilde";if(hk(t,l)){const g=l.enter("codeIndented"),w=l.indentLines(s,pk);return g(),w}const d=l.createTracker(u),p=o.repeat(Math.max(fk(s,o)+1,3)),m=l.enter("codeFenced");let y=d.move(p);if(t.lang){const g=l.enter(`codeFencedLang${c}`);y+=d.move(l.safe(t.lang,{before:y,after:" ",encode:["`"],...d.current()})),g()}if(t.lang&&t.meta){const g=l.enter(`codeFencedMeta${c}`);y+=d.move(" "),y+=d.move(l.safe(t.meta,{before:y,after:`
`,encode:["`"],...d.current()})),g()}return y+=d.move(`
`),s&&(y+=d.move(s+`
`)),y+=d.move(p),m(),y}function pk(t,r,l){return(l?"":"    ")+t}function oh(t){const r=t.options.quote||'"';if(r!=='"'&&r!=="'")throw new Error("Cannot serialize title with `"+r+"` for `options.quote`, expected `\"`, or `'`");return r}function gk(t,r,l,u){const o=oh(l),s=o==='"'?"Quote":"Apostrophe",c=l.enter("definition");let d=l.enter("label");const p=l.createTracker(u);let m=p.move("[");return m+=p.move(l.safe(l.associationId(t),{before:m,after:"]",...p.current()})),m+=p.move("]: "),d(),!t.url||/[\0- \u007F]/.test(t.url)?(d=l.enter("destinationLiteral"),m+=p.move("<"),m+=p.move(l.safe(t.url,{before:m,after:">",...p.current()})),m+=p.move(">")):(d=l.enter("destinationRaw"),m+=p.move(l.safe(t.url,{before:m,after:t.title?" ":`
`,...p.current()}))),d(),t.title&&(d=l.enter(`title${s}`),m+=p.move(" "+o),m+=p.move(l.safe(t.title,{before:m,after:o,...p.current()})),m+=p.move(o),d()),c(),m}function yk(t){const r=t.options.emphasis||"*";if(r!=="*"&&r!=="_")throw new Error("Cannot serialize emphasis with `"+r+"` for `options.emphasis`, expected `*`, or `_`");return r}function Li(t){return"&#x"+t.toString(16).toUpperCase()+";"}function xo(t,r,l){const u=Tl(t),o=Tl(r);return u===void 0?o===void 0?l==="_"?{inside:!0,outside:!0}:{inside:!1,outside:!1}:o===1?{inside:!0,outside:!0}:{inside:!1,outside:!0}:u===1?o===void 0?{inside:!1,outside:!1}:o===1?{inside:!0,outside:!0}:{inside:!1,outside:!1}:o===void 0?{inside:!1,outside:!1}:o===1?{inside:!0,outside:!1}:{inside:!1,outside:!1}}Vv.peek=vk;function Vv(t,r,l,u){const o=yk(l),s=l.enter("emphasis"),c=l.createTracker(u),d=c.move(o);let p=c.move(l.containerPhrasing(t,{after:o,before:d,...c.current()}));const m=p.charCodeAt(0),y=xo(u.before.charCodeAt(u.before.length-1),m,o);y.inside&&(p=Li(m)+p.slice(1));const g=p.charCodeAt(p.length-1),w=xo(u.after.charCodeAt(0),g,o);w.inside&&(p=p.slice(0,-1)+Li(g));const b=c.move(o);return s(),l.attentionEncodeSurroundingInfo={after:w.outside,before:y.outside},d+p+b}function vk(t,r,l){return l.options.emphasis||"*"}function bk(t,r){let l=!1;return ih(t,function(u){if("value"in u&&/\r?\n|\r/.test(u.value)||u.type==="break")return l=!0,Af}),!!((!t.depth||t.depth<3)&&$f(t)&&(r.options.setext||l))}function wk(t,r,l,u){const o=Math.max(Math.min(6,t.depth||1),1),s=l.createTracker(u);if(bk(t,l)){const y=l.enter("headingSetext"),g=l.enter("phrasing"),w=l.containerPhrasing(t,{...s.current(),before:`
`,after:`
`});return g(),y(),w+`
...
`,...s.current()});return/^[\t ]/.test(m)&&(m=Li(m.charCodeAt(0))+m.slice(1)),m=m?c+" "+m:c,l.options.closeAtx&&(m+=" "+c),p(),d(),m}Xv.peek=Sk;function Xv(t){return t.value||""}function Sk(){return"<"}Qv.peek=xk;function Qv(t,r,l,u){const o=oh(l),s=o==='"'?"Quote":"Apostrophe",c=l.enter("image");let d=l.enter("label");const p=l.createTracker(u);let m=p.move("![");return m+=p.move(l.safe(t.alt,{before:m,after:"]",...p.current()})),m+=p.move("]("),d(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(d=l.enter("destinationLiteral"),m+=p.move("<"),m+=p.move(l.safe(t.url,{before:m,after:">",...p.current()})),m+=p.move(">")):(d=l.enter("destinationRaw"),m+=p.move(l.safe(t.url,{before:m,after:t.title?" ":")",...p.current()}))),d(),t.title&&(d=l.enter(`title${s}`),m+=p.move(" "+o),m+=p.move(l.safe(t.title,{before:m,after:o,...p.current()})),m+=p.move(o),d()),m+=p.move(")"),c(),m}function xk(){return"!"}Zv.peek=Ek;function Zv(t,r,l,u){const o=t.referenceType,s=l.enter("imageReference");let c=l.enter("label");const d=l.createTracker(u);let p=d.move("![");const m=l.safe(t.alt,{before:p,after:"]",...d.current()});p+=d.move(m+"]["),c();const y=l.stack;l.stack=[],c=l.enter("reference");const g=l.safe(l.associationId(t),{before:p,after:"]",...d.current()});return c(),l.stack=y,s(),o==="full"||!m||m!==g?p+=d.move(g+"]"):o==="shortcut"?p=p.slice(0,-1):p+=d.move("]"),p}function Ek(){return"!"}Jv.peek=Tk;function Jv(t,r,l){let u=t.value||"",o="`",s=-1;for(;new RegExp("(^|[^`])"+o+"([^`]|$)").test(u);)o+="`";for(/[^ \r\n]/.test(u)&&(/^[ \r\n]/.test(u)&&/[ \r\n]$/.test(u)||/^`|`$/.test(u))&&(u=" "+u+" ");++s<l.unsafe.length;){const c=l.unsafe[s],d=l.compilePattern(c);let p;if(c.atBreak)for(;p=d.exec(u);){let m=p.index;u.charCodeAt(m)===10&&u.charCodeAt(m-1)===13&&m--,u=u.slice(0,m)+" "+u.slice(p.index+1)}}return o+u+o}function Tk(){return"`"}function Pv(t,r){const l=$f(t);return!!(!r.options.resourceLink&&t.url&&!t.title&&t.children&&t.children.length===1&&t.children[0].type==="text"&&(l===t.url||"mailto:"+l===t.url)&&/^[a-z][a-z+.-]+:/i.test(t.url)&&!/[\0- <>\u007F]/.test(t.url))}Kv.peek=Ck;function Kv(t,r,l,u){const o=oh(l),s=o==='"'?"Quote":"Apostrophe",c=l.createTracker(u);let d,p;if(Pv(t,l)){const y=l.stack;l.stack=[],d=l.enter("autolink");let g=c.move("<");return g+=c.move(l.containerPhrasing(t,{before:g,after:">",...c.current()})),g+=c.move(">"),d(),l.stack=y,g}d=l.enter("link"),p=l.enter("label");let m=c.move("[");return m+=c.move(l.containerPhrasing(t,{before:m,after:"](",...c.current()})),m+=c.move("]("),p(),!t.url&&t.title||/[\0- \u007F]/.test(t.url)?(p=l.enter("destinationLiteral"),m+=c.move("<"),m+=c.move(l.safe(t.url,{before:m,after:">",...c.current()})),m+=c.move(">")):(p=l.enter("destinationRaw"),m+=c.move(l.safe(t.url,{before:m,after:t.title?" ":")",...c.current()}))),p(),t.title&&(p=l.enter(`title${s}`),m+=c.move(" "+o),m+=c.move(l.safe(t.title,{before:m,after:o,...c.current()})),m+=c.move(o),p()),m+=c.move(")"),d(),m}function Ck(t,r,l){return Pv(t,l)?"<":"["}Wv.peek=kk;function Wv(t,r,l,u){const o=t.referenceType,s=l.enter("linkReference");let c=l.enter("label");const d=l.createTracker(u);let p=d.move("[");const m=l.containerPhrasing(t,{before:p,after:"]",...d.current()});p+=d.move(m+"]["),c();const y=l.stack;l.stack=[],c=l.enter("reference");const g=l.safe(l.associationId(t),{before:p,after:"]",...d.current()});return c(),l.stack=y,s(),o==="full"||!m||m!==g?p+=d.move(g+"]"):o==="shortcut"?p=p.slice(0,-1):p+=d.move("]"),p}function kk(){return"["}function sh(t){const r=t.options.bullet||"*";if(r!=="*"&&r!=="+"&&r!=="-")throw new Error("Cannot serialize items with `"+r+"` for `options.bullet`, expected `*`, `+`, or `-`");return r}function Rk(t){const r=sh(t),l=t.options.bulletOther;if(!l)return r==="*"?"-":"*";if(l!=="*"&&l!=="+"&&l!=="-")throw new Error("Cannot serialize items with `"+l+"` for `options.bulletOther`, expected `*`, `+`, or `-`");if(l===r)throw new Error("Expected `bullet` (`"+r+"`) and `bulletOther` (`"+l+"`) to be different");return l}function Ak(t){const r=t.options.bulletOrdered||".";if(r!=="."&&r!==")")throw new Error("Cannot serialize items with `"+r+"` for `options.bulletOrdered`, expected `.` or `)`");return r}function $v(t){const r=t.options.rule||"*";if(r!=="*"&&r!=="-"&&r!=="_")throw new Error("Cannot serialize rules with `"+r+"` for `options.rule`, expected `*`, `-`, or `_`");return r}function Dk(t,r,l,u){const o=l.enter("list"),s=l.bulletCurrent;let c=t.ordered?Ak(l):sh(l);const d=t.ordered?c==="."?")":".":Rk(l);let p=r&&l.bulletLastUsed?c===l.bulletLastUsed:!1;if(!t.ordered){const y=t.children?t.children[0]:void 0;if((c==="*"||c==="-")&&y&&(!y.children||!y.children[0])&&l.stack[l.stack.length-1]==="list"&&l.stack[l.stack.length-2]==="listItem"&&l.stack[l.stack.length-3]==="list"&&l.stack[l.stack.length-4]==="listItem"&&l.indexStack[l.indexStack.length-1]===0&&l.indexStack[l.indexStack.length-2]===0&&l.indexStack[l.indexStack.length-3]===0&&(p=!0),$v(l)===c&&y){let g=-1;for(;++g<t.children.length;){const w=t.children[g];if(w&&w.type==="listItem"&&w.children&&w.children[0]&&w.children[0].type==="thematicBreak"){p=!0;break}}}}p&&(c=d),l.bulletCurrent=c;const m=l.containerFlow(t,u);return l.bulletLastUsed=c,l.bulletCurrent=s,o(),m}function Mk(t){const r=t.options.listItemIndent||"one";if(r!=="tab"&&r!=="one"&&r!=="mixed")throw new Error("Cannot serialize items with `"+r+"` for `options.listItemIndent`, expected `tab`, `one`, or `mixed`");return r}function zk(t,r,l,u){const o=Mk(l);let s=l.bulletCurrent||sh(l);r&&r.type==="list"&&r.ordered&&(s=(typeof r.start=="number"&&r.start>-1?r.start:1)+(l.options.incrementListMarker===!1?0:r.children.indexOf(t))+s);let c=s.length+1;(o==="tab"||o==="mixed"&&(r&&r.type==="list"&&r.spread||t.spread))&&(c=Math.ceil(c/4)*4);const d=l.createTracker(u);d.move(s+" ".repeat(c-s.length)),d.shift(c);const p=l.enter("listItem"),m=l.indentLines(l.containerFlow(t,d.current()),y);return p(),m;function y(g,w,b){return w?(b?"":" ".repeat(c))+g:(b?s:s+" ".repeat(c-s.length))+g}}function _k(t,r,l,u){const o=l.enter("paragraph"),s=l.enter("phrasing"),c=l.containerPhrasing(t,u);return s(),o(),c}const Ok=Oo(["break","delete","emphasis","footnote","footnoteReference","image","imageReference","inlineCode","inlineMath","link","linkReference","mdxJsxTextElement","mdxTextExpression","strong","text","textDirective"]);function jk(t,r,l,u){return(t.children.some(function(c){return Ok(c)})?l.containerPhrasing:l.containerFlow).call(l,t,u)}function Nk(t){const r=t.options.strong||"*";if(r!=="*"&&r!=="_")throw new Error("Cannot serialize strong with `"+r+"` for `options.strong`, expected `*`, or `_`");return r}eb.peek=Lk;function eb(t,r,l,u){const o=Nk(l),s=l.enter("strong"),c=l.createTracker(u),d=c.move(o+o);let p=c.move(l.containerPhrasing(t,{after:o,before:d,...c.current()}));const m=p.charCodeAt(0),y=xo(u.before.charCodeAt(u.before.length-1),m,o);y.inside&&(p=Li(m)+p.slice(1));const g=p.charCodeAt(p.length-1),w=xo(u.after.charCodeAt(0),g,o);w.inside&&(p=p.slice(0,-1)+Li(g));const b=c.move(o+o);return s(),l.attentionEncodeSurroundingInfo={after:w.outside,before:y.outside},d+p+b}function Lk(t,r,l){return l.options.strong||"*"}function Uk(t,r,l,u){return l.safe(t.value,u)}function Hk(t){const r=t.options.ruleRepetition||3;if(r<3)throw new Error("Cannot serialize rules with repetition `"+r+"` for `options.ruleRepetition`, expected `3` or more");return r}function Bk(t,r,l){const u=($v(l)+(l.options.ruleSpaces?" ":"")).repeat(Hk(l));return l.options.ruleSpaces?u.slice(0,-1):u}const tb={blockquote:ok,break:vy,code:mk,definition:gk,emphasis:Vv,hardBreak:vy,heading:wk,html:Xv,image:Qv,imageReference:Zv,inlineCode:Jv,link:Kv,linkReference:Wv,list:Dk,listItem:zk,paragraph:_k,root:jk,strong:eb,text:Uk,thematicBreak:Bk};function Yk(){return{enter:{table:qk,tableData:by,tableHeader:by,tableRow:Fk},exit:{codeText:Gk,table:Ik,tableData:yf,tableHeader:yf,tableRow:yf}}}function qk(t){const r=t._align;this.enter({type:"table",align:r.map(function(l){return l==="none"?null:l}),children:[]},t),this.data.inTable=!0}function Ik(t){this.exit(t),this.data.inTable=void 0}function Fk(t){this.enter({type:"tableRow",children:[]},t)}function yf(t){this.exit(t)}function by(t){this.enter({type:"tableCell",children:[]},t)}function Gk(t){let r=this.resume();this.data.inTable&&(r=r.replace(/\\([\\|])/g,Vk));const l=this.stack[this.stack.length-1];l.type,l.value=r,this.exit(t)}function Vk(t,r){return r==="|"?r:t}function Xk(t){const r=t||{},l=r.tableCellPadding,u=r.tablePipeAlign,o=r.stringLength,s=l?" ":"|";return{unsafe:[{character:"\r",inConstruct:"tableCell"},{character:`
...
`))}function p(b,E,z,j){const A=z.enter("tableCell"),L=z.enter("phrasing"),H=z.containerPhrasing(b,{...j,before:s,after:s});return L(),A(),H}function m(b,E){return ik(b,{align:E,alignDelimiters:u,padding:l,stringLength:o})}function y(b,E,z){const j=b.children;let A=-1;const L=[],H=E.enter("table");for(;++A<j.length;)L[A]=g(j[A],E,z);return H(),L}function g(b,E,z){const j=b.children;let A=-1;const L=[],H=E.enter("tableRow");for(;++A<j.length;)L[A]=p(j[A],b,E,z);return H(),L}function w(b,E,z){let j=tb.inlineCode(b,E,z);return z.stack.includes("tableCell")&&(j=j.replace(/\|/g,"\\$&")),j}}function Qk(){return{exit:{taskListCheckValueChecked:wy,taskListCheckValueUnchecked:wy,paragraph:Jk}}}function Zk(){return{unsafe:[{atBreak:!0,character:"-",after:"[:|-]"}],handlers:{listItem:Pk}}}function wy(t){const r=this.stack[this.stack.length-2];r.type,r.checked=t.type==="taskListCheckValueChecked"}function Jk(t){const r=this.stack[this.stack.length-2];if(r&&r.type==="listItem"&&typeof r.checked=="boolean"){const l=this.stack[this.stack.length-1];l.type;const u=l.children[0];if(u&&u.type==="text"){const o=r.children;let s=-1,c;for(;++s<o.length;){const d=o[s];if(d.type==="paragraph"){c=d;break}}c===l&&(u.value=u.value.slice(1),u.value.length===0?l.children.shift():l.position&&u.position&&typeof u.position.start.offset=="number"&&(u.position.start.column++,u.position.start.offset++,l.position.start=Object.assign({},u.position.start)))}}this.exit(t)}function Pk(t,r,l,u){const o=t.children[0],s=typeof t.checked=="boolean"&&o&&o.type==="paragraph",c="["+(t.checked?"x":" ")+"] ",d=l.createTracker(u);s&&d.move(c);let p=tb.listItem(t,r,l,{...u,...d.current()});return s&&(p=p.replace(/^(?:[*+-]|\d+\.)([\r\n]| {1,3})/,m)),p;function m(y){return y+c}}function Kk(){return[DC(),PC(),ek(),Yk(),Qk()]}function Wk(t){return{extensions:[MC(),KC(t),tk(),Xk(t),Zk()]}}const $k={tokenize:lR,partial:!0},nb={tokenize:iR,partial:!0},ab={tokenize:uR,partial:!0},rb={tokenize:oR,partial:!0},eR={tokenize:sR,partial:!0},lb={name:"wwwAutolink",tokenize:aR,previous:ub},ib={name:"protocolAutolink",tokenize:rR,previous:ob},Ea={name:"emailAutolink",tokenize:nR,previous:sb},Wn={};function tR(){return{text:Wn}}let Mr=48;for(;Mr<123;)Wn[Mr]=Ea,Mr++,Mr===58?Mr=65:Mr===91&&(Mr=97);Wn[43]=Ea;Wn[45]=Ea;Wn[46]=Ea;Wn[95]=Ea;Wn[72]=[Ea,ib];Wn[104]=[Ea,ib];Wn[87]=[Ea,lb];Wn[119]=[Ea,lb];function nR(t,r,l){const u=this;let o,s;return c;function c(g){return!_f(g)||!sb.call(u,u.previous)||ch(u.events)?l(g):(t.enter("literalAutolink"),t.enter("literalAutolinkEmail"),d(g))}function d(g){return _f(g)?(t.consume(g),d):g===64?(t.consume(g),p):l(g)}function p(g){return g===46?t.check(eR,y,m)(g):g===45||g===95||Ft(g)?(s=!0,t.consume(g),p):y(g)}function m(g){return t.consume(g),o=!0,p}function y(g){return s&&o&&Qt(u.previous)?(t.exit("literalAutolinkEmail"),t.exit("literalAutolink"),r(g)):l(g)}}function aR(t,r,l){const u=this;return o;function o(c){return c!==87&&c!==119||!ub.call(u,u.previous)||ch(u.events)?l(c):(t.enter("literalAutolink"),t.enter("literalAutolinkWww"),t.check($k,t.attempt(nb,t.attempt(ab,s),l),l)(c))}function s(c){return t.exit("literalAutolinkWww"),t.exit("literalAutolink"),r(c)}}function rR(t,r,l){const u=this;let o="",s=!1;return c;function c(g){return(g===72||g===104)&&ob.call(u,u.previous)&&!ch(u.events)?(t.enter("literalAutolink"),t.enter("literalAutolinkHttp"),o+=String.fromCodePoint(g),t.consume(g),d):l(g)}function d(g){if(Qt(g)&&o.length<5)return o+=String.fromCodePoint(g),t.consume(g),d;if(g===58){const w=o.toLowerCase();if(w==="http"||w==="https")return t.consume(g),p}return l(g)}function p(g){return g===47?(t.consume(g),s?m:(s=!0,p)):l(g)}function m(g){return g===null||bo(g)||st(g)||_r(g)||Mo(g)?l(g):t.attempt(nb,t.attempt(ab,y),l)(g)}function y(g){return t.exit("literalAutolinkHttp"),t.exit("literalAutolink"),r(g)}}function lR(t,r,l){let u=0;return o;function o(c){return(c===87||c===119)&&u<3?(u++,t.consume(c),o):c===46&&u===3?(t.consume(c),s):l(c)}function s(c){return c===null?l(c):r(c)}}function iR(t,r,l){let u,o,s;return c;function c(m){return m===46||m===95?t.check(rb,p,d)(m):m===null||st(m)||_r(m)||m!==45&&Mo(m)?p(m):(s=!0,t.consume(m),c)}function d(m){return m===95?u=!0:(o=u,u=void 0),t.consume(m),c}function p(m){return o||u||!s?l(m):r(m)}}function uR(t,r){let l=0,u=0;return o;function o(c){return c===40?(l++,t.consume(c),o):c===41&&u<l?s(c):c===33||c===34||c===38||c===39||c===41||c===42||c===44||c===46||c===58||c===59||c===60||c===63||c===93||c===95||c===126?t.check(rb,r,s)(c):c===null||st(c)||_r(c)?r(c):(t.consume(c),o)}function s(c){return c===41&&u++,t.consume(c),o}}function oR(t,r,l){return u;function u(d){return d===33||d===34||d===39||d===41||d===42||d===44||d===46||d===58||d===59||d===63||d===95||d===126?(t.consume(d),u):d===38?(t.consume(d),s):d===93?(t.consume(d),o):d===60||d===null||st(d)||_r(d)?r(d):l(d)}function o(d){return d===null||d===40||d===91||st(d)||_r(d)?r(d):u(d)}function s(d){return Qt(d)?c(d):l(d)}function c(d){return d===59?(t.consume(d),u):Qt(d)?(t.consume(d),c):l(d)}}function sR(t,r,l){return u;function u(s){return t.consume(s),o}function o(s){return Ft(s)?l(s):r(s)}}function ub(t){return t===null||t===40||t===42||t===95||t===91||t===93||t===126||st(t)}function ob(t){return!Qt(t)}function sb(t){return!(t===47||_f(t))}function _f(t){return t===43||t===45||t===46||t===95||Ft(t)}function ch(t){let r=t.length,l=!1;for(;r--;){const u=t[r][1];if((u.type==="labelLink"||u.type==="labelImage")&&!u._balanced){l=!0;break}if(u._gfmAutolinkLiteralWalkedInto){l=!1;break}}return t.length>0&&!l&&(t[t.length-1][1]._gfmAutolinkLiteralWalkedInto=!0),l}const cR={tokenize:vR,partial:!0};function fR(){return{document:{91:{name:"gfmFootnoteDefinition",tokenize:pR,continuation:{tokenize:gR},exit:yR}},text:{91:{name:"gfmFootnoteCall",tokenize:mR},93:{name:"gfmPotentialFootnoteCall",add:"after",tokenize:hR,resolveTo:dR}}}}function hR(t,r,l){const u=this;let o=u.events.length;const s=u.parser.gfmFootnotes||(u.parser.gfmFootnotes=[]);let c;for(;o--;){const p=u.events[o][1];if(p.type==="labelImage"){c=p;break}if(p.type==="gfmFootnoteCall"||p.type==="labelLink"||p.type==="label"||p.type==="image"||p.type==="link")break}return d;function d(p){if(!c||!c._balanced)return l(p);const m=Fn(u.sliceSerialize({start:c.end,end:u.now()}));return m.codePointAt(0)!==94||!s.includes(m.slice(1))?l(p):(t.enter("gfmFootnoteCallLabelMarker"),t.consume(p),t.exit("gfmFootnoteCallLabelMarker"),r(p))}}function dR(t,r){let l=t.length;for(;l--;)if(t[l][1].type==="labelImage"&&t[l][0]==="enter"){t[l][1];break}t[l+1][1].type="data",t[l+3][1].type="gfmFootnoteCallLabelMarker";const u={type:"gfmFootnoteCall",start:Object.assign({},t[l+3][1].start),end:Object.assign({},t[t.length-1][1].end)},o={type:"gfmFootnoteCallMarker",start:Object.assign({},t[l+3][1].end),end:Object.assign({},t[l+3][1].end)};o.end.column++,o.end.offset++,o.end._bufferIndex++;const s={type:"gfmFootnoteCallString",start:Object.assign({},o.end),end:Object.assign({},t[t.length-1][1].start)},c={type:"chunkString",contentType:"string",start:Object.assign({},s.start),end:Object.assign({},s.end)},d=[t[l+1],t[l+2],["enter",u,r],t[l+3],t[l+4],["enter",o,r],["exit",o,r],["enter",s,r],["enter",c,r],["exit",c,r],["exit",s,r],t[t.length-2],t[t.length-1],["exit",u,r]];return t.splice(l,t.length-l+1,...d),t}function mR(t,r,l){const u=this,o=u.parser.gfmFootnotes||(u.parser.gfmFootnotes=[]);let s=0,c;return d;function d(g){return t.enter("gfmFootnoteCall"),t.enter("gfmFootnoteCallLabelMarker"),t.consume(g),t.exit("gfmFootnoteCallLabelMarker"),p}function p(g){return g!==94?l(g):(t.enter("gfmFootnoteCallMarker"),t.consume(g),t.exit("gfmFootnoteCallMarker"),t.enter("gfmFootnoteCallString"),t.enter("chunkString").contentType="string",m)}function m(g){if(s>999||g===93&&!c||g===null||g===91||st(g))return l(g);if(g===93){t.exit("chunkString");const w=t.exit("gfmFootnoteCallString");return o.includes(Fn(u.sliceSerialize(w)))?(t.enter("gfmFootnoteCallLabelMarker"),t.consume(g),t.exit("gfmFootnoteCallLabelMarker"),t.exit("gfmFootnoteCall"),r):l(g)}return st(g)||(c=!0),s++,t.consume(g),g===92?y:m}function y(g){return g===91||g===92||g===93?(t.consume(g),s++,m):m(g)}}function pR(t,r,l){const u=this,o=u.parser.gfmFootnotes||(u.parser.gfmFootnotes=[]);let s,c=0,d;return p;function p(E){return t.enter("gfmFootnoteDefinition")._container=!0,t.enter("gfmFootnoteDefinitionLabel"),t.enter("gfmFootnoteDefinitionLabelMarker"),t.consume(E),t.exit("gfmFootnoteDefinitionLabelMarker"),m}function m(E){return E===94?(t.enter("gfmFootnoteDefinitionMarker"),t.consume(E),t.exit("gfmFootnoteDefinitionMarker"),t.enter("gfmFootnoteDefinitionLabelString"),t.enter("chunkString").contentType="string",y):l(E)}function y(E){if(c>999||E===93&&!d||E===null||E===91||st(E))return l(E);if(E===93){t.exit("chunkString");const z=t.exit("gfmFootnoteDefinitionLabelString");return s=Fn(u.sliceSerialize(z)),t.enter("gfmFootnoteDefinitionLabelMarker"),t.consume(E),t.exit("gfmFootnoteDefinitionLabelMarker"),t.exit("gfmFootnoteDefinitionLabel"),w}return st(E)||(d=!0),c++,t.consume(E),E===92?g:y}function g(E){return E===91||E===92||E===93?(t.consume(E),c++,y):y(E)}function w(E){return E===58?(t.enter("definitionMarker"),t.consume(E),t.exit("definitionMarker"),o.includes(s)||o.push(s),Ze(t,b,"gfmFootnoteDefinitionWhitespace")):l(E)}function b(E){return r(E)}}function gR(t,r,l){return t.check(Fi,r,t.attempt(cR,r,l))}function yR(t){t.exit("gfmFootnoteDefinition")}function vR(t,r,l){const u=this;return Ze(t,o,"gfmFootnoteDefinitionIndent",5);function o(s){const c=u.events[u.events.length-1];return c&&c[1].type==="gfmFootnoteDefinitionIndent"&&c[2].sliceSerialize(c[1],!0).length===4?r(s):l(s)}}function bR(t){let l=(t||{}).singleTilde;const u={name:"strikethrough",tokenize:s,resolveAll:o};return l==null&&(l=!0),{text:{126:u},insideSpan:{null:[u]},attentionMarkers:{null:[126]}};function o(c,d){let p=-1;for(;++p<c.length;)if(c[p][0]==="enter"&&c[p][1].type==="strikethroughSequenceTemporary"&&c[p][1]._close){let m=p;for(;m--;)if(c[m][0]==="exit"&&c[m][1].type==="strikethroughSequenceTemporary"&&c[m][1]._open&&c[p][1].end.offset-c[p][1].start.offset===c[m][1].end.offset-c[m][1].start.offset){c[p][1].type="strikethroughSequence",c[m][1].type="strikethroughSequence";const y={type:"strikethrough",start:Object.assign({},c[m][1].start),end:Object.assign({},c[p][1].end)},g={type:"strikethroughText",start:Object.assign({},c[m][1].end),end:Object.assign({},c[p][1].start)},w=[["enter",y,d],["enter",c[m][1],d],["exit",c[m][1],d],["enter",g,d]],b=d.parser.constructs.insideSpan.null;b&&vn(w,w.length,0,zo(b,c.slice(m+1,p),d)),vn(w,w.length,0,[["exit",g,d],["enter",c[p][1],d],["exit",c[p][1],d],["exit",y,d]]),vn(c,m-1,p-m+3,w),p=m+w.length-2;break}}for(p=-1;++p<c.length;)c[p][1].type==="strikethroughSequenceTemporary"&&(c[p][1].type="data");return c}function s(c,d,p){const m=this.previous,y=this.events;let g=0;return w;function w(E){return m===126&&y[y.length-1][1].type!=="characterEscape"?p(E):(c.enter("strikethroughSequenceTemporary"),b(E))}function b(E){const z=Tl(m);if(E===126)return g>1?p(E):(c.consume(E),g++,b);if(g<2&&!l)return p(E);const j=c.exit("strikethroughSequenceTemporary"),A=Tl(E);return j._open=!A||A===2&&!!z,j._close=!z||z===2&&!!A,d(E)}}}class wR{constructor(){this.map=[]}add(r,l,u){SR(this,r,l,u)}consume(r){if(this.map.sort(function(s,c){return s[0]-c[0]}),this.map.length===0)return;let l=this.map.length;const u=[];for(;l>0;)l-=1,u.push(r.slice(this.map[l][0]+this.map[l][1]),this.map[l][2]),r.length=this.map[l][0];u.push(r.slice()),r.length=0;let o=u.pop();for(;o;){for(const s of o)r.push(s);o=u.pop()}this.map.length=0}}function SR(t,r,l,u){let o=0;if(!(l===0&&u.length===0)){for(;o<t.map.length;){if(t.map[o][0]===r){t.map[o][1]+=l,t.map[o][2].push(...u);return}o+=1}t.map.push([r,l,u])}}function xR(t,r){let l=!1;const u=[];for(;r<t.length;){const o=t[r];if(l){if(o[0]==="enter")o[1].type==="tableContent"&&u.push(t[r+1][1].type==="tableDelimiterMarker"?"left":"none");else if(o[1].type==="tableContent"){if(t[r-1][1].type==="tableDelimiterMarker"){const s=u.length-1;u[s]=u[s]==="left"?"center":"right"}}else if(o[1].type==="tableDelimiterRow")break}else o[0]==="enter"&&o[1].type==="tableDelimiterRow"&&(l=!0);r+=1}return u}function ER(){return{flow:{null:{name:"table",tokenize:TR,resolveAll:CR}}}}function TR(t,r,l){const u=this;let o=0,s=0,c;return d;function d(U){let ee=u.events.length-1;for(;ee>-1;){const ce=u.events[ee][1].type;if(ce==="lineEnding"||ce==="linePrefix")ee--;else break}const ae=ee>-1?u.events[ee][1].type:null,De=ae==="tableHead"||ae==="tableRow"?q:p;return De===q&&u.parser.lazy[u.now().line]?l(U):De(U)}function p(U){return t.enter("tableHead"),t.enter("tableRow"),m(U)}function m(U){return U===124||(c=!0,s+=1),y(U)}function y(U){return U===null?l(U):Re(U)?s>1?(s=0,u.interrupt=!0,t.exit("tableRow"),t.enter("lineEnding"),t.consume(U),t.exit("lineEnding"),b):l(U):Be(U)?Ze(t,y,"whitespace")(U):(s+=1,c&&(c=!1,o+=1),U===124?(t.enter("tableCellDivider"),t.consume(U),t.exit("tableCellDivider"),c=!0,y):(t.enter("data"),g(U)))}function g(U){return U===null||U===124||st(U)?(t.exit("data"),y(U)):(t.consume(U),U===92?w:g)}function w(U){return U===92||U===124?(t.consume(U),g):g(U)}function b(U){return u.interrupt=!1,u.parser.lazy[u.now().line]?l(U):(t.enter("tableDelimiterRow"),c=!1,Be(U)?Ze(t,E,"linePrefix",u.parser.constructs.disable.null.includes("codeIndented")?void 0:4)(U):E(U))}function E(U){return U===45||U===58?j(U):U===124?(c=!0,t.enter("tableCellDivider"),t.consume(U),t.exit("tableCellDivider"),z):oe(U)}function z(U){return Be(U)?Ze(t,j,"whitespace")(U):j(U)}function j(U){return U===58?(s+=1,c=!0,t.enter("tableDelimiterMarker"),t.consume(U),t.exit("tableDelimiterMarker"),A):U===45?(s+=1,A(U)):U===null||Re(U)?fe(U):oe(U)}function A(U){return U===45?(t.enter("tableDelimiterFiller"),L(U)):oe(U)}function L(U){return U===45?(t.consume(U),L):U===58?(c=!0,t.exit("tableDelimiterFiller"),t.enter("tableDelimiterMarker"),t.consume(U),t.exit("tableDelimiterMarker"),H):(t.exit("tableDelimiterFiller"),H(U))}function H(U){return Be(U)?Ze(t,fe,"whitespace")(U):fe(U)}function fe(U){return U===124?E(U):U===null||Re(U)?!c||o!==s?oe(U):(t.exit("tableDelimiterRow"),t.exit("tableHead"),r(U)):oe(U)}function oe(U){return l(U)}function q(U){return t.enter("tableRow"),M(U)}function M(U){return U===124?(t.enter("tableCellDivider"),t.consume(U),t.exit("tableCellDivider"),M):U===null||Re(U)?(t.exit("tableRow"),r(U)):Be(U)?Ze(t,M,"whitespace")(U):(t.enter("data"),te(U))}function te(U){return U===null||U===124||st(U)?(t.exit("data"),M(U)):(t.consume(U),U===92?de:te)}function de(U){return U===92||U===124?(t.consume(U),te):te(U)}}function CR(t,r){let l=-1,u=!0,o=0,s=[0,0,0,0],c=[0,0,0,0],d=!1,p=0,m,y,g;const w=new wR;for(;++l<t.length;){const b=t[l],E=b[1];b[0]==="enter"?E.type==="tableHead"?(d=!1,p!==0&&(Sy(w,r,p,m,y),y=void 0,p=0),m={type:"table",start:Object.assign({},E.start),end:Object.assign({},E.end)},w.add(l,0,[["enter",m,r]])):E.type==="tableRow"||E.type==="tableDelimiterRow"?(u=!0,g=void 0,s=[0,0,0,0],c=[0,l+1,0,0],d&&(d=!1,y={type:"tableBody",start:Object.assign({},E.start),end:Object.assign({},E.end)},w.add(l,0,[["enter",y,r]])),o=E.type==="tableDelimiterRow"?2:y?3:1):o&&(E.type==="data"||E.type==="tableDelimiterMarker"||E.type==="tableDelimiterFiller")?(u=!1,c[2]===0&&(s[1]!==0&&(c[0]=c[1],g=fo(w,r,s,o,void 0,g),s=[0,0,0,0]),c[2]=l)):E.type==="tableCellDivider"&&(u?u=!1:(s[1]!==0&&(c[0]=c[1],g=fo(w,r,s,o,void 0,g)),s=c,c=[s[1],l,0,0])):E.type==="tableHead"?(d=!0,p=l):E.type==="tableRow"||E.type==="tableDelimiterRow"?(p=l,s[1]!==0?(c[0]=c[1],g=fo(w,r,s,o,l,g)):c[1]!==0&&(g=fo(w,r,c,o,l,g)),o=0):o&&(E.type==="data"||E.type==="tableDelimiterMarker"||E.type==="tableDelimiterFiller")&&(c[3]=l)}for(p!==0&&Sy(w,r,p,m,y),w.consume(r.events),l=-1;++l<r.events.length;){const b=r.events[l];b[0]==="enter"&&b[1].type==="table"&&(b[1]._align=xR(r.events,l))}return t}function fo(t,r,l,u,o,s){const c=u===1?"tableHeader":u===2?"tableDelimiter":"tableData",d="tableContent";l[0]!==0&&(s.end=Object.assign({},wl(r.events,l[0])),t.add(l[0],0,[["exit",s,r]]));const p=wl(r.events,l[1]);if(s={type:c,start:Object.assign({},p),end:Object.assign({},p)},t.add(l[1],0,[["enter",s,r]]),l[2]!==0){const m=wl(r.events,l[2]),y=wl(r.events,l[3]),g={type:d,start:Object.assign({},m),end:Object.assign({},y)};if(t.add(l[2],0,[["enter",g,r]]),u!==2){const w=r.events[l[2]],b=r.events[l[3]];if(w[1].end=Object.assign({},b[1].end),w[1].type="chunkText",w[1].contentType="text",l[3]>l[2]+1){const E=l[2]+1,z=l[3]-l[2]-1;t.add(E,z,[])}}t.add(l[3]+1,0,[["exit",g,r]])}return o!==void 0&&(s.end=Object.assign({},wl(r.events,o)),t.add(o,0,[["exit",s,r]]),s=void 0),s}function Sy(t,r,l,u,o){const s=[],c=wl(r.events,l);o&&(o.end=Object.assign({},c),s.push(["exit",o,r])),u.end=Object.assign({},c),s.push(["exit",u,r]),t.add(l+1,0,s)}function wl(t,r){const l=t[r],u=l[0]==="enter"?"start":"end";return l[1][u]}const kR={name:"tasklistCheck",tokenize:AR};function RR(){return{text:{91:kR}}}function AR(t,r,l){const u=this;return o;function o(p){return u.previous!==null||!u._gfmTasklistFirstContentOfListItem?l(p):(t.enter("taskListCheck"),t.enter("taskListCheckMarker"),t.consume(p),t.exit("taskListCheckMarker"),s)}function s(p){return st(p)?(t.enter("taskListCheckValueUnchecked"),t.consume(p),t.exit("taskListCheckValueUnchecked"),c):p===88||p===120?(t.enter("taskListCheckValueChecked"),t.consume(p),t.exit("taskListCheckValueChecked"),c):l(p)}function c(p){return p===93?(t.enter("taskListCheckMarker"),t.consume(p),t.exit("taskListCheckMarker"),t.exit("taskListCheck"),d):l(p)}function d(p){return Re(p)?r(p):Be(p)?t.check({tokenize:DR},r,l)(p):l(p)}}function DR(t,r,l){return Ze(t,u,"whitespace");function u(o){return o===null?l(o):r(o)}}function MR(t){return wv([tR(),fR(),bR(t),ER(),RR()])}const zR={};function _R(t){const r=this,l=t||zR,u=r.data(),o=u.micromarkExtensions||(u.micromarkExtensions=[]),s=u.fromMarkdownExtensions||(u.fromMarkdownExtensions=[]),c=u.toMarkdownExtensions||(u.toMarkdownExtensions=[]);o.push(MR(l)),s.push(Kk()),c.push(Wk(l))}const Eo=t=>t.trim().toLowerCase().replace(/[\u200B-\u200D\uFEFF]/g,"").replace(/_/g,"").replace(/[^\w\s-]/g,"").replace(/\s+/g,"-").replace(/-+/g,"-").replace(/^-|-$/g,"");function Of(t){return t==null?"":typeof t=="string"||typeof t=="number"||typeof t=="boolean"?String(t):Array.isArray(t)?t.map(r=>Of(r)).join(""):G.isValidElement(t)?Of(t.props.children??null):""}function OR(t){const r=t.split(`
`);let l=0;for(;l<r.length&&r[l].trim()==="";)l++;if(l<r.length&&/^#\s+/.test(r[l].trim())){for(l++;l<r.length&&r[l].trim()==="";)l++;return r.slice(l).join(`
`)}return t}const vl=(t,r)=>{const l=Of(t),u=Eo(l);return u?`${r??""}${u}`:void 0};function xy({markdown:t,stripFirstH1:r,headingIdPrefix:l}){const u=G.useMemo(()=>r?OR(t):t,[t,r]);return se.jsx("div",{className:"markdown",children:se.jsx(bC,{remarkPlugins:[_R],components:{h1:({children:o,...s})=>{const c=vl(o,l);return se.jsx("h1",{id:c,...s,className:"text-4xl font-bold lineheight-1.25 mb-4",children:o})},h2:({children:o,...s})=>{const c=vl(o,l);return se.jsx("h2",{id:c,...s,className:"text-3xl font-bold lineheight-1.25 mb-4",children:o})},h3:({children:o,...s})=>{const c=vl(o,l);return se.jsx("h3",{id:c,...s,className:"text-2xl font-bold lineheight-1.25 mb-4",children:o})},h4:({children:o,...s})=>{const c=vl(o,l);return se.jsx("h4",{id:c,...s,className:"text-xl font-semibold lineheight-1.25 mb-4",children:o})},h5:({children:o,...s})=>{const c=vl(o,l);return se.jsx("h5",{id:c,...s,className:"text-lg font-semibold lineheight-1.25 mb-4",children:o})},h6:({children:o,...s})=>{const c=vl(o,l);return se.jsx("h6",{id:c,...s,className:"text-base font-semibold lineheight-1.25 mb-4",children:o})},p:({children:o,...s})=>se.jsx("p",{...s,className:"mb-4 lineheight-1.5",children:o}),pre:({children:o,...s})=>se.jsx("pre",{...s,className:"bg-gray-100 p-4 rounded mb-4 overflow-x-auto",children:o}),code:({children:o,...s})=>se.jsx("code",{...s,className:"bg-gray-100 px-1 py-0.5 rounded",children:o}),ol:({children:o,...s})=>se.jsx("ol",{...s,className:"list-inside mb-4",children:o}),li:({children:o,...s})=>se.jsx("li",{...s,className:"mb-2",children:o})},children:u})})}const jR=`# Temperature Converter 
...
<br >
<br >
`,NR=`# Test-Driven Development (TDD) Guide
...
- Practice handling multiple conditions`,QR=`
...
</details>`,JR=`# Rock Paper Scissors
...
- ECMAScript 2015 (ES6) specification notes`,eA=`
# Function Documentation
...
- **\`.indexOf()\`** - Finds the index of an element ([MDN](https://developer.mozilla.org/en-US/docs/Web/JavaScript/Reference/Global_Objects/Array/indexOf))`,rA=`# Step-by-Step Instructions
...
`;function oA(t){const r=t.replace(/\\/g,"/");return r.match(/(?:^|\/)(?:docs)(?:\/)([^/]+)(?:\/)/)?.[1]??r.split("/").slice(-2,-1)[0]??"unknown"}function sA(t){const r=t.match(/^(\d+)\b/);return r?Number(r[1]):Number.MAX_SAFE_INTEGER}function cA(t){return t.replace(/\\/g,"/").split("/").slice(-1)[0]??"unknown.md"}const Ey=t=>t.replace(/\.md$/i,"").replace(/\d+/g,"").replace(/[-_]+/g," ").trim(),Ty={"instructions.md":0,"readme.md":1,"function_documentation.md":2,"function-documentation.md":2,"extra_guide.md":3,"extra-guide.md":3,"solution.md":4};function fA(t,r){const l=t.toLowerCase(),u=r.toLowerCase(),o=Ty[l]??100,s=Ty[u]??100;return o-s||l.localeCompare(u)}const hA={glob(){return Object.assign({"../../../../docs/1-temperature-converter/README.md":jR,"../../../../docs/1-temperature-converter/TDD-guide.md":NR,"../../../../docs/1-temperature-converter/function-documentation.md":LR,"../../../../docs/1-temperature-converter/instructions.md":UR,"../../../../docs/1-temperature-converter/solution.md":HR,"../../../../docs/2-dog-age-calculator/README.md":BR,"../../../../docs/2-dog-age-calculator/function-documentation.md":YR,"../../../../docs/2-dog-age-calculator/instructions.md":qR,"../../../../docs/2-dog-age-calculator/solution.md":IR,"../../../../docs/3-magic-eight-ball/README.md":FR,"../../../../docs/3-magic-eight-ball/function-documentation.md":GR,"../../../../docs/3-magic-eight-ball/instructions.md":VR,"../../../../docs/4-race-day/README.md":XR,"../../../../docs/4-race-day/function-documentation.md":QR,"../../../../docs/4-race-day/instructions.md":ZR,"../../../../docs/5-rock-paper-scissors/README.md":JR,"../../../../docs/5-rock-paper-scissors/function-documentation.md":PR,"../../../../docs/5-rock-paper-scissors/instructions.md":KR,"../../../../docs/6-sleep-calculator/README.md":WR,"../../../../docs/6-sleep-calculator/arrow-functions.md":$R,"../../../../docs/6-sleep-calculator/function-documentation.md":eA,"../../../../docs/6-sleep-calculator/instructions.md":tA,"../../../../docs/7-coded-message/README.md":nA,"../../../../docs/7-coded-message/class-documentation.md":aA,"../../../../docs/7-coded-message/instructions.md":rA,"../../../../docs/8-whale-talk/README.md":lA,"../../../../docs/8-whale-talk/function-documentation.md":iA,"../../../../docs/8-whale-talk/instructions.md":uA})}};function dA(t){const r=new Map;for(const[u,o]of Object.entries(t)){const s=oA(u),c=cA(u),d={fileName:c,title:Ey(c),markdown:o},p=r.get(s);p?p.push(d):r.set(s,[d])}const l=Array.from(r.entries()).map(([u,o])=>{const s=[...o].sort((c,d)=>fA(c.fileName,d.fileName));return{slug:u,title:Ey(u),order:sA(u),files:s.map(c=>({title:c.title,markdown:c.markdown}))}});return l.sort((u,o)=>u.order-o.order||u.title.localeCompare(o.title)),l}function cb(){return G.useMemo(()=>{const t=hA.glob();return dA(t)},[])}const mA=`# JavaScript Learning Challenges
...
`;var fb={color:void 0,size:void 0,className:void 0,style:void 0,attr:void 0},Cy=ar.createContext&&ar.createContext(fb),pA=["attr","size","title"];function gA(t,r){if(t==null)return{};var l=yA(t,r),u,o;if(Object.getOwnPropertySymbols){var s=Object.getOwnPropertySymbols(t);for(o=0;o<s.length;o++)u=s[o],!(r.indexOf(u)>=0)&&Object.prototype.propertyIsEnumerable.call(t,u)&&(l[u]=t[u])}return l}function yA(t,r){if(t==null)return{};var l={};for(var u in t)if(Object.prototype.hasOwnProperty.call(t,u)){if(r.indexOf(u)>=0)continue;l[u]=t[u]}return l}function To(){return To=Object.assign?Object.assign.bind():function(t){for(var r=1;r<arguments.length;r++){var l=arguments[r];for(var u in l)Object.prototype.hasOwnProperty.call(l,u)&&(t[u]=l[u])}return t},To.apply(this,arguments)}function ky(t,r){var l=Object.keys(t);if(Object.getOwnPropertySymbols){var u=Object.getOwnPropertySymbols(t);r&&(u=u.filter(function(o){return Object.getOwnPropertyDescriptor(t,o).enumerable})),l.push.apply(l,u)}return l}function Co(t){for(var r=1;r<arguments.length;r++){var l=arguments[r]!=null?arguments[r]:{};r%2?ky(Object(l),!0).forEach(function(u){vA(t,u,l[u])}):Object.getOwnPropertyDescriptors?Object.defineProperties(t,Object.getOwnPropertyDescriptors(l)):ky(Object(l)).forEach(function(u){Object.defineProperty(t,u,Object.getOwnPropertyDescriptor(l,u))})}return t}function vA(t,r,l){return r=bA(r),r in t?Object.defineProperty(t,r,{value:l,enumerable:!0,configurable:!0,writable:!0}):t[r]=l,t}function bA(t){var r=wA(t,"string");return typeof r=="symbol"?r:r+""}function wA(t,r){if(typeof t!="object"||!t)return t;var l=t[Symbol.toPrimitive];if(l!==void 0){var u=l.call(t,r);if(typeof u!="object")return u;throw new TypeError("@@toPrimitive must return a primitive value.")}return(r==="string"?String:Number)(t)}function hb(t){return t&&t.map((r,l)=>ar.createElement(r.tag,Co({key:l},r.attr),hb(r.child)))}function SA(t){return r=>ar.createElement(xA,To({attr:Co({},t.attr)},r),hb(t.child))}function xA(t){var r=l=>{var{attr:u,size:o,title:s}=t,c=gA(t,pA),d=o||l.size||"1em",p;return l.className&&(p=l.className),t.className&&(p=(p?p+" ":"")+t.className),ar.createElement("svg",To({stroke:"currentColor",fill:"currentColor",strokeWidth:"0"},l.attr,u,c,{className:p,style:Co(Co({color:t.color||l.color},l.style),t.style),height:d,width:d,xmlns:"http://www.w3.org/2000/svg"}),s&&ar.createElement("title",null,s),t.children)};return Cy!==void 0?ar.createElement(Cy.Consumer,null,l=>r(l)):r(fb)}function EA(t){return SA({attr:{viewBox:"0 0 1024 1024"},child:[{tag:"path",attr:{d:"M8.2 275.4c0-8.6 3.4-17.401 10-24.001 13.2-13.2 34.8-13.2 48 0l451.8 451.8 445.2-445.2c13.2-13.2 34.8-13.2 48 0s13.2 34.8 0 48L542 775.399c-13.2 13.2-34.8 13.2-48 0l-475.8-475.8c-6.8-6.8-10-15.4-10-24.199z"},child:[]}]})(t)}const TA=({title:t,slug:r,files:l})=>{const[u,o]=G.useState(!1),{slug:s}=$y(),c=s?.replace(/\d/g,"").split("-").join(" ").trim()===t?l.find(p=>`#${Eo(p.title)}`===window.location.hash)?.title??t:null,d=p=>{p.stopPropagation(),o(!u)};return se.jsxs("section",{children:[se.jsxs("div",{style:{cursor:"pointer",display:"flex",alignItems:"baseline"},className:"navlink",children:[se.jsx(vo,{to:`/instructions/${r}`,onClick:()=>{u||o(!0)},style:{fontWeight:c===t?700:400,textDecoration:"none",flex:"1 1 auto",border:"none",paddingLeft:8},children:t}),se.jsx("button",{style:{border:"none",outline:"none",boxShadow:"none",background:"none",padding:0,margin:"0 8px 0 0",display:"inline-flex",alignItems:"center",justifyContent:"center",lineHeight:1,height:"1em",width:"1em",verticalAlign:"baseline"},onClick:d,children:se.jsx("span",{style:{transform:u?"rotate(180deg)":"rotate(0deg)",display:"inline-block",transition:"transform 0.2s"},children:se.jsx(EA,{})})})]}),u&&se.jsx("ul",{style:{listStyle:"none",margin:0,padding:0,display:"flex",flexDirection:"column",gap:12},children:l.map(p=>{if(p.title.toLowerCase()==="readme")return null;const m=p.title.toLowerCase()==="readme"?"":`#${Eo(p.title)}`,y=`/instructions/${r}${m}`;return se.jsx("li",{style:{padding:0},className:"navlink accordion-link",children:se.jsx(vo,{to:y,style:{fontWeight:c===p.title?700:400,textDecoration:"none",opacity:.9,border:"none",paddingLeft:24},children:p.title})},`${r}-${p.title}`)})})]})},CA=()=>{const t=cb();return se.jsx("aside",{"aria-label":"Challenges",style:{height:"100%",display:"flex",flexDirection:"column",overflow:"hidden"},children:se.jsx("nav",{style:{overflowY:"auto",overflowX:"hidden",minHeight:0,flex:"1 1 auto",paddingRight:16},children:se.jsxs("ul",{style:{listStyle:"none",padding:0,margin:0,gap:12,display:"flex",flexDirection:"column",fontSize:18},children:[se.jsx("li",{className:"navlink",children:se.jsx(vo,{to:$a.SETUP.path,style:({isActive:r})=>({fontWeight:r?700:400,textDecoration:"none"}),children:"Overview"})}),t.map(r=>se.jsx("li",{style:{padding:0,margin:0},children:se.jsx(TA,{slug:r.slug,title:r.title,files:r.files})},r.slug))]})})})};function kA(t,r){if(t)return r?.files.find(o=>`#${Eo(o.title)}`===t)?.markdown??"no markdown";const l=r?.files.find(o=>o.title.toLowerCase()==="readme")?.markdown;return l||(r?.files.find(o=>o.title.toLowerCase()==="instructions")?.markdown??"No instructions.md or README.md found for this challenge.")}function Ry(){const t=cb(),{slug:r}=$y(),{hash:l}=xa(),u=Wy(),o=G.useMemo(()=>r?t.findIndex(m=>m.slug===r):-1,[t,r]),s=t.find(m=>m.slug===r),c=G.useMemo(()=>kA(l,s),[l,s]),d=o>0?t[o-1]:void 0,p=o>=0&&o<t.length-1?t[o+1]:void 0;return t.length===0?se.jsxs("div",{className:"inner",children:[se.jsx("h1",{children:"Instructions"}),se.jsxs("p",{children:["No docs markdown found. Check the glob path in ",se.jsx("code",{children:"useChallengeInstructions"}),"."]})]}):se.jsxs("div",{id:"main",style:{display:"grid",height:"100vh",gridTemplateColumns:"280px 1fr",gap:24},children:[se.jsx(CA,{}),se.jsxs("section",{"aria-label":"Instructions",style:{overflow:"auto",height:"100%"},children:[!r&&se.jsx(xy,{markdown:mA}),r&&!s&&se.jsxs(se.Fragment,{children:[se.jsx("h1",{style:{marginTop:0},children:"Instructions"}),se.jsx("p",{children:"Unknown challenge. Pick one from the list."})]}),s&&se.jsxs(se.Fragment,{children:[se.jsx("header",{style:{display:"flex",alignItems:"center",justifyContent:"space-between",gap:12},children:se.jsxs("div",{style:{display:"flex",gap:8},children:[se.jsx("button",{disabled:!d,onClick:()=>d&&u(`/instructions/${d.slug}`),children:"Prev"}),se.jsx("button",{disabled:!p,onClick:()=>p&&u(`/instructions/${p.slug}`),children:"Next"})]})}),se.jsx(xy,{markdown:c})]})]})]})}const RA="/js-content/pr-preview/pr-62/",AA=RA.replace(/\/$/,""),DA=VS([{path:"/",element:se.jsx(ox,{}),children:[{path:"/instructions",element:se.jsx(Ry,{})},{path:"/instructions/:slug",element:se.jsx(Ry,{})},{path:"*",element:se.jsxs("div",{className:"w-full h-full flex flex-col items-center justify-center gap-4",children:[se.jsx("h1",{children:"404 Not Found"}),se.jsx("p",{children:"The page you are looking for does not exist."}),se.jsx(Do,{to:$a.HOME.path,children:"Go back to Home"})]})}]}],{basename:AA}),db=document.getElementById("root");if(!db)throw new Error('Root element "#root" not found');M1.createRoot(db).render(se.jsx(yS,{router:DA}));
