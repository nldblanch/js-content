...
describe('ErrorPage', () => {
  ...
  test('renders the 404 heading and not found message', () => {
    ...
    expect(screen.getByText(/the page you are looking for does not exist/i)).toBeDefined();
  });
  ...
  test('renders the arrow icon decoration', () => {
    ...
    const icon = screen.getByRole('presentation', { hidden: true }) || screen.getByAltText('');
