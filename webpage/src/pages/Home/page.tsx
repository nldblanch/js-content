...
import { VSCodeWindow } from '@src/ui/VSCodeWindow';
...
export default function Home() {
  ...
  // Try it yourself`}
      ...
      <p className="text-gray text-2xl font-normal font-fira mx-auto">
        The included exercises will teach you some of the following Skills.
      </p>
