...
export const Navigation = () => {
  ...
  return (
    <aside
      ...
      className="h-full flex flex-col overflow-hidden bg-black-800 border-r border-white/5"
    >
      <div className="p-6">
        <h2 className="font-fira text-gray text-2xl uppercase tracking-wider mb-8">Challenges</h2>
      </div>
          ...
          <li className="navlink">
            <NavLink
              ...
              className={({ isActive }) => `
                                ...
                                ${isActive ? 'text-white font-bold' : 'text-gray hover:text-white'}
                            `}
            >
              Overview
            </NavLink>
