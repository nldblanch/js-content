...
describe('sortFiles', () => {
  test('sorts files based on priority and name', () => {
    const files = ['solution.md', 'readme.md', 'extra_guide.md', 'instructions.md', 'function_documentation.md'];
...
describe('useChallengeInstructions (hook)', () => {
  test('returns built instructions and memoizes the glob call', () => {
    ...
    const globSpy = vi.spyOn(challenge.challengeDocsGlobber, 'glob').mockReturnValue(modules);
