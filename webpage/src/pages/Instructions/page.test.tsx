...
vi.mock('./components/MarkdownRenderer', () => ({
  MarkdownRenderer: ({ markdown }: { markdown: string }) => <pre data-testid="markdown">{markdown}</pre>,
}));
...
describe('InstructionsPage', () => {
  ...
  test('renders repo README on overview route', () => {
    mocks.useChallengeInstructionsMock.mockReturnValue([{ slug: '01-intro', title: 'intro', order: 1, files: [] }]);
