...
const CreateRepoForm = ({ onSubmit }: CreateRepoFormProps) => {
  ...
  const handleSubmit = async (e: React.SubmitEvent) => {
    ...
    setError(null);
    try {
      await onSubmit(repoName, addReadme);
    } catch (err: unknown) {
      setError(
      ...
      <div className="max-w-[820px] mx-auto py-10 px-4 md:px-8">
        ...
        <div className="border-b border-[#30363d] pb-4 mb-8">
          ...
          <p className="text-[#8b949e] mt-1 text-sm">
            ...
            project elsewhere?
            <span className="text-[#58a6ff] cursor-pointer hover:underline ml-1">
              Import a repository.
            </span>
          </p>
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="flex flex-col md:flex-row items-start md:items-end gap-2">
            ...
            <span className="hidden md:block text-2xl mb-1 text-[#8b949e]">
              /
            </span>
          ...
          <div>
            ...
            <p className="text-xs text-[#8b949e] mt-2">0 / 350 characters</p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-xs text-[#8b949e] ml-6 -mt-3">
              READMEs can be used as longer descriptions. <u>About READMEs</u>
            </p>
          </div>
          ...
          <div className="flex items-start gap-2 text-[#8b949e] text-xs">
            ...
            <p>
              As this is a tutorial application, Public and Private will have no
              effect on repo creation!
            </p>
          </div>
          ...
          <button
            ...
            className="bg-[#238636] hover:bg-[#2ea043] disabled:opacity-50 disabled:hover:bg-[#238636] disabled:cursor-not-allowed text-white px-5 py-2 rounded-md font-semibold transition-colors shadow-sm cursor-pointer"
          >
