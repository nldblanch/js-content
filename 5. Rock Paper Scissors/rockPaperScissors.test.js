...
describe("Rock Paper Scissors", () => {
  ...
  describe("determineWinner", () => {
    test("tie cases", () => {
      ...
      expect(rps.determineWinner("scissors", "scissors")).toBe(
        "The game is a tie!"
      );
    });
    ...
    test("paper beats rock, loses to scissors", () => {
      ...
      expect(rps.determineWinner("paper", "scissors")).toBe(
        "The computer won!"
      );
    });
    ...
    test("it handles invalid options", () => {
      expect(rps.determineWinner("fork", "knife")).toBe(
